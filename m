...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id 60CDD457E63
	for <lists+b.a.t.m.a.n@lfdr.de>; Sat, 20 Nov 2021 13:40:56 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id CBEFE83ECD;
	Sat, 20 Nov 2021 13:40:13 +0100 (CET)
Received: from dvalin.narfation.org (dvalin.narfation.org [IPv6:2a00:17d8:100::8b1])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id B456383EAF
...
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1637412008; a=rsa-sha256;
	cv=none;
	b=obsO/Lo1Q5l/cHLQIVkkW1cyQM8q0pa7E/IbH/PqHQ/Oo0Hu9R1eH2go/GrKXWQaliqMAY
	hjh3HTr1DhIdlKTJ6R2gxX02BP33D+YAqZsChnCiYMjyRqd6DNj3xzW0ldSKC+RX+dTpI6
	H+BIPnPxqbZqsAUieOOVLaOP+Fryf5A=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	...
	bh=zy1fzS5d5g8q0QGMoTRohwBbFNIzOKfXtlPyV2RUaIY=;
	b=MJLyVPUc1bCXfuJyTrJyAsCEIVMjEpnCsiHB2K9SD3SX9dBHkrqaBJRA9cwPj+tPZwzdWD
	n3AnCmNnNQjrtLQNZtGmjlta2aVm+QU6RLRJ9CCkW8tyUONG4Wm4oO0OUl+3KbcPpx49UK
	YFjP3UOezASsI63mQQ0GC7NzhXEm1P8=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=narfation.org header.s=20121 header.b=H0J5xVYG;
	spf=pass (diktynna.open-mesh.org: domain of sven@narfation.org designates 2a00:17d8:100::8b1 as permitted sender) smtp.mailfrom=sven@narfation.org;
	dmarc=pass (policy=none) header.from=narfation.org
Content-Transfer-Encoding: quoted-printable
Message-ID-Hash: YIWRZFBIL4HI63BH7PKN3DEMPGBXIOSJ
X-Message-ID-Hash: YIWRZFBIL4HI63BH7PKN3DEMPGBXIOSJ
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/YIWRZFBIL4HI63BH7PKN3DEMPGBXIOSJ/>
...
=20
@@ -1639,8 +1640,21 @@ bool batadv_bla_check_bcast_duplist(struct batadv_=
priv *bat_priv,
 		if (entry->crc !=3D crc)
 			continue;
=20
...
@@ -1656,7 +1670,14 @@ bool batadv_bla_check_bcast_duplist(struct batadv_=
priv *bat_priv,
...
=20
 out:
@@ -1665,6 +1686,48 @@ bool batadv_bla_check_bcast_duplist(struct batadv_=
priv *bat_priv,
 	return ret;
 }
=20
...
@@ -1879,6 +1942,14 @@ bool batadv_bla_rx(struct batadv_priv *bat_priv, s=
truct sk_buff *skb,

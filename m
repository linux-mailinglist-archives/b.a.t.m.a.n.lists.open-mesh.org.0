...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 89177516F0F
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon,  2 May 2022 13:47:06 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 8CD9482E80;
	Mon,  2 May 2022 13:47:05 +0200 (CEST)
Received: from s2.neomailbox.net (s2.neomailbox.net [5.148.176.60])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id C60FA80146
	for <b.a.t.m.a.n@lists.open-mesh.org>; Mon,  2 May 2022 13:47:01 +0200 (CEST)
From: Marek Lindner <mareklindner@neomailbox.ch>
To: b.a.t.m.a.n@lists.open-mesh.org
Subject: [PATCH v2] alfred: notify event listener via unix socket
Date: Mon,  2 May 2022 13:46:51 +0200
Message-Id: <20220502114651.771309-1-mareklindner@neomailbox.ch>
MIME-Version: 1.0
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1651492022; a=rsa-sha256;
	cv=none;
	b=kdZaMtyH/nn3o/7lHYkVm9HMR9bT73Bvy3ON5BhfrRCSz4PPFBKwsZhV4LPWM7c6w0pF/5
	PbWI0MPOrPIqe4xd7jb/6z7xQlKsCxAqQFIwg1QXurvUD2IcVE4NH2zwwv8vaxmXsfasLg
	xSQtlLh8KxW1oXOjOiTiwBcDnprhclk=
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1651492022;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding;
	bh=NtgT/wKD8HeA4S5+ETmLdY+ILOPfva8eP3wRvSuoifc=;
	b=Yz/Iv/Fb/GlMk3RAywNcRvWXD1OwoRjNYbBYUtI4oZzHDOBZqLlWULIBqb+cteHlG8xTj5
	PT1veldvxg4SI8kVainUcCtkTXd/Bja0j6bJhhbqp5Sr3AYstN+hQBHoxOlbF+YezlFB04
	OYxzY4Xpn+RKYcoT/gV+/HG/l5mbA0o=
Content-Transfer-Encoding: quoted-printable
Message-ID-Hash: I7K2TFC4OIKRYIBKX45FBZLA5WSS5Z7C
X-Message-ID-Hash: I7K2TFC4OIKRYIBKX45FBZLA5WSS5Z7C
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/I7K2TFC4OIKRYIBKX45FBZLA5WSS5Z7C/>
...
+			continue;
+
+		fprintf(stdout, "Event: type =3D %hhu\n", event_notify.type);
+	}
+
+err:
+	unix_sock_close(globals);

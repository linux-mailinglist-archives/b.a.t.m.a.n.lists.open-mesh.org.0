...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id CBF082695E6
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 14 Sep 2020 21:53:56 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 0C13C80823;
	Mon, 14 Sep 2020 21:53:53 +0200 (CEST)
Received: from mail.aperture-lab.de (mail.aperture-lab.de [IPv6:2a01:4f8:171:314c::100:a1])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id A77BE8027F
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=c0d3.blue; s=2018;
	...
	b=
To: b.a.t.m.a.n@lists.open-mesh.org
Cc: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
Subject: [PATCH maint v5 1/3] batman-adv: mcast: fix duplicate mcast packets in BLA backbone from LAN
Date: Mon, 14 Sep 2020 21:53:45 +0200
Message-Id: <20200914195347.10505-2-linus.luessing@c0d3.blue>
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	...
	bh=jAZhb2TOIFneokrXV6NhfMy5oFgt9Cj2pr5Ax67vdes=;
	b=EfwEmQmKINqSla43CvG4FLJkXNX09jpOP2lCUyv8q6jFtIKLUC89JpD2myy/N/hRFLzKd0
	ypOKADnqO8fz6s0N/FceIvnXUfLmqM+bf23gZcOyP5zoc66GcMSMFnIHPFWBZ6RFY2oXtj
	WwMC/xHK78ntvliU5QzetAT5H/mixts=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1600113230; a=rsa-sha256;
	cv=none;
	b=QlsSdKxVJJYHV7zloUpCvCGwQBZCUFEkaiaxf+HkJ9Z4vDf0ZBr3/MOYLvQSvl5uX3347J
	ky/8SQW3zAdcG2ErRr45zHUIWh9hK5Rq3AupQqOZWC2zKkBV4evkw7vat+Q39+MDbOKOIZ
	mJHMOX2wnpTKqANcBCI0ApKI7l3p56o=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=none (invalid DKIM record) header.d=c0d3.blue header.s=2018 header.b=C+2vkcQt;
...
Message-ID-Hash: AIPS2HCXB6KOKLTKHIDCWFNDKHFKSOWL
X-Message-ID-Hash: AIPS2HCXB6KOKLTKHIDCWFNDKHFKSOWL
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/AIPS2HCXB6KOKLTKHIDCWFNDKHFKSOWL/>

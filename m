...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 86D96A014FA
	for <lists+b.a.t.m.a.n@lfdr.de>; Sat,  4 Jan 2025 14:19:19 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 63465841E5
	for <lists+b.a.t.m.a.n@lfdr.de>; Sat,  4 Jan 2025 14:19:19 +0100 (CET)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1735996759;
 b=A5mfqDUXrqlTtedUVa7yAhpC+rLxUbWmhoBZS0DMoisUpO4uSC/uB7Afd3npGECaaOF0O
 Hh/Ew9h7+tDAp9UDL5q58uZT/AlhHMWTolyTQFjXeJOV8iTyz1IJhnrJaT2EvduqFrFqaU8
 UV+K5BfftQFT1QC2oajCROkO5hvZLEQ=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1735996759; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=fcjpTs6Q+mfwNXdv6hpX4yssGC761QDhUklXs0pAhTs=;
 b=pfvnRpuDga0hKqTbsGWi+30Nz2hP959/YPz2T5N9qda2VtxkiQLf9iim/Q+tlwlqV7iAE
 ZmtdwrwzXrNFhO2FX7wo8MMUu8buA03Vs6ebGJ6IEeAFVTHkNOV2PcOx4iiRz4fpNi4bXtl
 m9V31FXUNMBQruYD8NinK+TQdtJ3Y4E=
...
Received: from mail-pl1-x634.google.com (mail-pl1-x634.google.com
 [IPv6:2607:f8b0:4864:20::634])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id C8D2683F6E
	for <b.a.t.m.a.n@lists.open-mesh.org>; Sat,  4 Jan 2025 13:58:04 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1735995484;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=fcjpTs6Q+mfwNXdv6hpX4yssGC761QDhUklXs0pAhTs=;
	b=tNF8ctPCe4yAG6XPGgDRE7BNaFIzGkNxzrF2AiXnw6sA6jSTCiKA3idgWBVd8Vj2csa6Zg
	0xpP87IGFyjzPVhpS4Di/5nNiuEqah0LhEcdvcVdUSPAThHrDK2yI9Fw6xhp+sbnHTYfgt
	kMggXJjplBCNY6r7EUArFR2L1CZh9iE=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=gmail.com header.s=20230601 header.b="fYhtJ/AL";
	dmarc=pass (policy=none) header.from=gmail.com;
	spf=pass (diktynna.open-mesh.org: domain of shaw.leon@gmail.com designates
 2607:f8b0:4864:20::634 as permitted sender) smtp.mailfrom=shaw.leon@gmail.com
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1735995485; a=rsa-sha256;
	cv=none;
	b=LaoPedKt4IHrYch9wF918sY868zCHqbIindxiZq8WKrlky6Ug4r/uSP1Yih0TkIii2zC0z
	mP5fu1UNnjtI5qP6NpbuT7lsbUBNRVu8czm47Cpa9PouasYU1LRyNZbY/bcbUEzcCILIlp
	Jwt5Qw8N4NNMrFVwhXbMyAP+5Bphb20=
Received: by mail-pl1-x634.google.com with SMTP id
 d9443c01a7336-21649a7bcdcso178339175ad.1
        for <b.a.t.m.a.n@lists.open-mesh.org>;
 Sat, 04 Jan 2025 04:58:04 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1735995483; x=1736600283;
 darn=lists.open-mesh.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=fcjpTs6Q+mfwNXdv6hpX4yssGC761QDhUklXs0pAhTs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=fcjpTs6Q+mfwNXdv6hpX4yssGC761QDhUklXs0pAhTs=;
        b=
X-Forwarded-Encrypted: i=1;
 AJvYcCX41tPgp++cHbJ5QZH8zMU4OaDQ4bWwYOWGDXN/Z1JWg4f1TBlijYuwPiTBPSLLePujreW099SPq0hA/w==@lists.open-mesh.org
X-Gm-Message-State: AOJu0YzlJ9qM4MHGysJqHyVgJeBwPfNrDW2LOrMaIkBPQEcLjvLg6ffz
	M5vCm7Nx4Cn9wwH9tOflnOx1T55eTHgby3+Wt2lLeZtHK/5L20qZ
X-Gm-Gg: 
X-Google-Smtp-Source: 
 AGHT+IEof4Ug9Jw0VMzYDDjW/tMo2iAMDI/x7nst5L28DNQsgH8g8chegJ2MfqyfFeNVpKOoy68daQ==
X-Received: by 2002:a05:6a00:3286:b0:725:b201:2353 with SMTP id
 d2e1a72fcca58-72abdec8856mr80567493b3a.13.1735995482888;
        Sat, 04 Jan 2025 04:58:02 -0800 (PST)
Received: from ws.. ([103.167.140.11])
        by smtp.gmail.com with ESMTPSA id
 d2e1a72fcca58-72aad830349sm27761344b3a.47.2025.01.04.04.57.54
...
Subject: [PATCH net-next v7 02/11] rtnetlink: Pack newlink() params into
 struct
...
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/52UO35ET4JSJ2BAR2FWTPN6UX5TII7DG/>
List-Archive: 

...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id EB52619C3A3
	for <lists+b.a.t.m.a.n@lfdr.de>; Thu,  2 Apr 2020 16:10:39 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 4AB74808F6;
	Thu,  2 Apr 2020 16:10:38 +0200 (CEST)
Received: from mx0a-001b2d01.pphosted.com (mx0b-001b2d01.pphosted.com
 [148.163.158.5])
 by diktynna.open-mesh.org (Postfix) with ESMTPS id 4C34C8002D
 for <b.a.t.m.a.n@lists.open-mesh.org>; Thu,  2 Apr 2020 16:06:24 +0200 (CEST)
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org; 
 s=20121; t=1585836384;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=gyCz3QfXAzwsvgxFbtbJcDdRA2jSsX+jib1DFC+YYAM=;
 b=2XlnCADPaknHgz57kxuFZEnMrkp4iRnCQ7w93cqUEhZzRozM+c5OUBU9nPy+HQsZGFvhPp
 a4C6jp6bQttYeXHbUImUmrEqdhtXDwTBotczn7onW3/tw//LaUufHXnnE1zK4bsQ1SrfOv
 r7oPNdyf9jzWsaaiASv6GUTZZOhEy8E=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1585836384; a=rsa-sha256; cv=none;
 b=wex4c2Q8qEGCnD8AOXS1lKYSl7vybmVpJX5F3dGFp0kqPWX0VOfDoqjsLSa3admpomwTPw
 I7FATVdEJHQGI+BObO1je8zuO2JOdKNlRxWxRPk/EFG+12dQrv2sAtADwOjoo0T08OlzC+
 OguFxDeRjBOfxR7dDMhEZbMJl+EUIts=
ARC-Authentication-Results: i=1; diktynna.open-mesh.org; dkim=none;
 spf=pass (diktynna.open-mesh.org: domain of muriloo@linux.ibm.com designates
 148.163.158.5 as permitted sender) smtp.mailfrom=muriloo@linux.ibm.com
X-Mailman-Approved-At: Thu, 02 Apr 2020 16:10:36 +0200
...
Reply-To: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n@lists.open-mesh.org>
Cc: tytso@mit.edu, mareklindner@neomailbox.ch, benh@kernel.crashing.org,
 b.a.t.m.a.n@lists.open-mesh.org, a@unstable.cc, linux-kernel@vger.kernel.org,
 syzkaller-bugs@googlegroups.com, netdev@vger.kernel.org,
 adilger.kernel@dilger.ca, mpe@ellerman.id.au, paulus@samba.org,
 linux-ext4@vger.kernel.org, linuxppc-dev@lists.ozlabs.org, davem@davemloft.net

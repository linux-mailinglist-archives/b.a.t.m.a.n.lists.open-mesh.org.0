...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D78048B8CF6
	for <lists+b.a.t.m.a.n@lfdr.de>; Wed,  1 May 2024 17:28:53 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id B2505825AC
	for <lists+b.a.t.m.a.n@lfdr.de>; Wed,  1 May 2024 17:28:53 +0200 (CEST)
ARC-Seal: i=3; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1714577333;
 b=d5G9qA65h1r/GCJ3U+Ygy1SB5M09jvLKsqz+j3l3DiqHOHd23v7wXC4qazOYj95gP+4p5
 tVTCnOf2UqSCKxBZ3AB+1blxnxPimHwAy48na/45+PzM5Z7y0mmta6RxV06fXGkI9XB/baI
 BOoO7v/MNuAZHoSIK85hmg5qDp2DPp0=
ARC-Message-Signature: i=3; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1714577333; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=bQnpgDZbgfR03GHCw1uuEcglzZ0kuvsUMlWln8jcunU=;
 b=iHG7oiVs0Am4q+802yAP1yiDeDTyLavcvv8vhsCos1s8eeYLnVXWAjDAhCj2Oy461guQ3
 Sga0QdgPCHYBw3yXERrPDK9K5fBqjs0zenrrHwPAe1mGs6lwmRbuXBPWyIpEsmWrE9X+iHx
 ShFL2mYSistWFT7Bi9SvNokh/D1W3y8=
...
Received: from EUR05-DB8-obe.outbound.protection.outlook.com
 (mail-db8eur05acsn20809.outbound.protection.outlook.com
 [IPv6:2a01:111:f400:7e1a::809])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 8972481A34
	for <b.a.t.m.a.n@lists.open-mesh.org>; Wed,  1 May 2024 17:03:08 +0200 (CEST)
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1714575789;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:dkim-signature;
	bh=bQnpgDZbgfR03GHCw1uuEcglzZ0kuvsUMlWln8jcunU=;
	b=w+cxg+KSXG9hcptikUzTKeCcqAcbNurgtzljPpV9ys8cbc5tsBTWIQYZMrri9W6AZzjGqS
	ZYfrSuX6ldXePmk+q3SFk5OJqk23wgshvz+wRw9DAI4SOCbbr4PJzWX7D7FZ5WFFA05M4s
	Aym25TMqlDrY9TnWH1n7gGXj0+7Qkbw=
ARC-Seal: i=2; s=20121; d=open-mesh.org; t=1714575789; a=rsa-sha256;
	cv=pass;
	b=pByrI934DJ2OLCivhj5jOLCYIK+jiIM65WtB/M1wdRLgYrhnz9E5xWjvwj9YpCAHFiVs/R
	k3pzXfXMMTXBMUwyHczaxzy4xN1/vM/xIPnsImPdIxyL66SFzYIDKiDaIg3d4kEbIGTQ77
	0zCfrZHGwJ9o9xlE2H6D9P1NvVYVikk=
ARC-Authentication-Results: i=2;
	diktynna.open-mesh.org;
	dkim=pass header.d=outlook.com header.s=selector1 header.b=CZhMs9Jj;
	spf=pass (diktynna.open-mesh.org: domain of erick.archer@outlook.com
 designates 2a01:111:f400:7e1a::809 as permitted sender)
...
X-MS-Exchange-CrossTenant-Network-Message-Id: 
 b31d4515-5949-45aa-0c3e-08dc69efce84
...
Message-ID-Hash: NMXG277MMWSNWOKNUX3NVRBGCII543PP
X-Message-ID-Hash: NMXG277MMWSNWOKNUX3NVRBGCII543PP
X-Mailman-Approved-At: Wed, 01 May 2024 17:28:24 +0200
X-Mailman-Version: 3.3.8
Precedence: list
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/ASWGUKMJCST3KMZERRHBKKZAK3M7KUZS/>
List-Archive: 

...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id 431D9A24E01
	for <lists+b.a.t.m.a.n@lfdr.de>; Sun,  2 Feb 2025 13:41:54 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 1345783F16
	for <lists+b.a.t.m.a.n@lfdr.de>; Sun,  2 Feb 2025 13:41:54 +0100 (CET)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1738500114;
 b=tAyHvFZxzTm1GP6kjleHLUBE+EFfwgroZKtojcyPdnMmdNg59u1t2uB6M+Gaepc8ohgL1
 SYTvkd1TiGIteZ0qjmE/NJrLRkfxpUC7XE1Qwp02OCHigWd+NquavTsa+XjM/cXrVoTURYF
 Pbd/AaEJxbcBDweA8lrlEAaWUwgj7Cw=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1738500114; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=V8mgfd75WvSbzLizGLp+gykr++sIQ1icFWb1xQmk3Dc=;
 b=Rd9BMzbPaqHAij5Bfodh21ZW78QCiA0sRJJxU7z8j30WjufoZZdY7kFQ8f8/xs1gDdP2I
 Sk1Mzo2A40Y+MZSce20FzNKYkga1MIVgW8fy0tfMV5xYkSn5qqJPuhWfcjKM8BgyUqgtJnb
 s+G8SBzaWQL4mfOGZQvqRrOB2N/MhkA=
...
Received: from dvalin.narfation.org (dvalin.narfation.org [213.160.73.56])
	by diktynna.open-mesh.org (Postfix) with UTF8SMTPS id D4EE8824FC
	for <b.a.t.m.a.n@lists.open-mesh.org>; Sun,  2 Feb 2025 13:39:45 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1738499986;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:dkim-signature;
	bh=V8mgfd75WvSbzLizGLp+gykr++sIQ1icFWb1xQmk3Dc=;
	b=HffVCVGy+hvAVzTRtG/sgyaUElwbdRIs0rAbafra8Dy1l+glHMI1wk1CZnC9LmfNUNWh3L
	QhAsrLBwfCMlkbodlPgu+At7m+zgSOU0pQ9D3xLDXFNRzOgeUPas6Os8ZgmqGb/FztWy/T
	7Bmm3pta3/ytceluU7XK9LsqpZtwT7c=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=narfation.org header.s=20121 header.b=ZDICg7ol;
	spf=pass (diktynna.open-mesh.org: domain of sven@narfation.org designates
 213.160.73.56 as permitted sender) smtp.mailfrom=sven@narfation.org;
	dmarc=pass (policy=none) header.from=narfation.org
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1738499986; a=rsa-sha256;
	cv=none;
	b=IguO/+B8csuOubE5g5iH9M6v7cpD1/UQu8AV5QdA1N6QK2mOHp/JCFr41LeYSv2p4Wg7Ze
	1Zq8hQgcr6wBMRD3gpTvMIuR59RKIB3JF+oTLJfLN4C5MbJWWJMrD/eMkgGkPw50Btmn0R
	BBKYhqjcSLuAg8X+PUR2J+0c6LszjUs=
Received: from sven-desktop.home.narfation.org (unknown
 [IPv6:2a00:1ca0:1d86:2efc::8411])
	by dvalin.narfation.org (Postfix) with UTF8SMTPSA id A829F20CB6;
	Sun,  2 Feb 2025 12:39:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=narfation.org;
	s=20121; t=1738499985;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding;
	bh=V8mgfd75WvSbzLizGLp+gykr++sIQ1icFWb1xQmk3Dc=;
	b=ZDICg7oljJW4s2LlQCC/LyokA2Ls2AGEusBnQNfcwAVrTn8dexnL2OEWtSjOw10dXbioac
	K6oAUthTI6NLgPTbOgcW70Rt2/PBkGZf7ecawHscad6XHRjIRcgm4N6T84fcA0mSm+Gfv5
	+PmpXlU8d+6oNLOsIIdZT8dyHUwN3n0=
From: Sven Eckelmann <sven@narfation.org>
Date: Sun, 02 Feb 2025 13:39:32 +0100
Subject: [PATCH] batman-adv: Use consistent name for mesh interface
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20250202-meshif-v1-1-c448555793f2@narfation.org>
X-B4-Tracking: v=1; b=H4sIAINnn2cC/6tWKk4tykwtVrJSqFYqSi3LLM7MzwNyDHUUlJIzE
 vPSU3UzU4B8JSMDI1MDIKGbm1qckZmmm5SSkpqUkmpkZpFmrgRUXFCUmpZZATYoOra2FgALgXF
 rWAAAAA==
X-Change-ID: 20250202-meshif-bddebde268f7
To: b.a.t.m.a.n@lists.open-mesh.org
Cc: Sven Eckelmann <sven@narfation.org>
X-Mailer: b4 0.14.2
X-Developer-Signature: v=1; a=openpgp-sha256; l=298800; i=sven@narfation.org;
 h=from:subject:message-id; bh=lfxGkVtNBrBKBrpnZHSkfeOluPYrKzHRIm6KZWE8rxM=;
 b=owGbwMvMwCXmy1+ufVnk62nG02pJDOnz07t5uh7vlNWovMzQGF65S3jp/ljmh7n7JPXWZcROm
 CR2b8u8jlIWBjEuBlkxRZY9V/LPb2Z/K/952sejMHNYmUCGMHBxCsBEPF8wMqz2iWNLsJJKXyks
 lzNlP1fzV+c30nm3NeW/HWeI2uN3/wDD/+iI7/dqWcWsrj6cajNt7cOgsOxXBmtef9qY+qZ6xZZ
 NLMwA
...
Message-ID-Hash: YBTZERWGOUIRGVOYO22QDLG7MKPBSENB
X-Message-ID-Hash: YBTZERWGOUIRGVOYO22QDLG7MKPBSENB
X-Mailman-Approved-At: Sun, 02 Feb 2025 13:40:58 +0100
X-Mailman-Version: 3.3.8
Precedence: list
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/YBTZERWGOUIRGVOYO22QDLG7MKPBSENB/>
List-Archive: 
...
---
 ...
 net/batman-adv/hard-interface.c                    | 138 +++++++-------
 ...
 40 files changed, 881 insertions(+), 881 deletions(-)

diff --git a/CHANGELOG.rst b/CHANGELOG.rst
index 87eb68629107bc6ce64a137d771c8b5894a1520a..dbb049eca4abb4c5d831144a2c72226ec8161897 100644
--- a/CHANGELOG.rst
+++ b/CHANGELOG.rst
@@ -46,7 +46,7 @@
...
index 44b9b5cc0e24ba25c29af8ba95a57651821d776f..ec53a42499c139306c8328419b1b97dfe21e15a0 100644
...
index 18a02531455a0d4adacbde38ae683449b302e61b..f0a3c0a67ad03464f18bf718db99d750da6f47d9 100644
...
index 35dc016c9bb41b91e59ab2b698c1097e6396cbfb..936bcac270b5e3b6fc10a0df64ee2f2925cef4bb 100644
...
index b51d8b071b5621910f1d550a1ca6ce0a18d4a60a..775dd2cf51161b3f09361da549e74416ede1e104 100644
--- a/net/batman-adv/Makefile
+++ b/net/batman-adv/Makefile
@@ -26,7 +26,7 @@ batman-adv-$(CONFIG_BATMAN_ADV_NC) += network-coding.o
...
index 4eee53d19eb047bea986184498a3ef98ed6c84df..c0c982b6f029229ac4462e531ad0bfefc87964dd 100644
...
index 07ae5dd1f150b062e97897b269d45b041e8b4dfe..8513f6661dd10079baf717bb98b4bbf3f21e5e95 100644
...
index d35479c465e2c4868be4f7ec02f8626e54c1bb92..c16c2e60889d2551bd02895226c7aa04e8497e68 100644
...
index b065578b4436ee6b173e1201b0ad68af9c250f3b..70d6778da0d7bd9fff9621fe4123de4d970a6f2e 100644
...
index e503ee0d896bd52bb5827102a7a57fc07279f0bd..3b9065a3c746a90b634f1ee230e054cfcbcfeb27 100644
...
index 649c41f393e1acc1b957c721c14b06387bf4d4b8..2c49b27116503d1ee0d70d72aa4444b37f16bc81 100644
...
index 8c814f790d177af74963acf3c7bb71b1dc307ae1..747755647c6a4a6130856cb822551b7ec51ea7ce 100644
...
index e5a07152d4ecf02230ec7dd0b58ce03ba556d8bb..8b8132eb0a79faca1615c5df9aed10d1b913b0be 100644
...
index bed7f3d2084442221a9d2f014c8e1cff961cf32a..e7b75e82eb1d8a8bd849b3edf26d7cde6f101146 100644
...
index 757c084ac2d1452ccdab428775fd4badb66aa558..cc14bc41381e09b9dddab43727a0d8c6b17823a6 100644
...
index f68e34ed1f627561b2dfaf5f650150ae4cbc64f3..7a11b245e9f4050818861ad1197c41cb41b9b805 100644
...
index 2dd36ef03c841981835ab619da6b143baabc8c9e..315fa90f0c947f0ec77f8e488b2823cdb77a96fa 100644
...
index 96a412beab2de9069c0f88e4cd844fbc0922aa18..be53ef6738016fc247285e411d038a5d40508ced 100644
...
@@ -627,15 +627,15 @@ int batadv_hardif_min_mtu(struct net_device *soft_iface)
 /**
...
@@ -643,12 +643,12 @@ void batadv_update_min_mtu(struct net_device *soft_iface)
...
+	batadv_tt_local_resize_to_mtu(mesh_iface);
 ...
 static void
@@ -660,7 +660,7 @@ batadv_hardif_activate_interface(struct batadv_hard_iface *hard_iface)
...
+	bat_priv = netdev_priv(hard_iface->mesh_iface);
 	...
 	hard_iface->if_status = BATADV_IF_TO_BE_ACTIVATED;
@@ -672,10 +672,10 @@ batadv_hardif_activate_interface(struct batadv_hard_iface *hard_iface)
 	if (!primary_if)
...
@@ -693,21 +693,21 @@ batadv_hardif_deactivate_interface(struct batadv_hard_iface *hard_iface)
...
@@ -717,7 +717,7 @@ int batadv_hardif_enable_interface(struct batadv_hard_iface *hard_iface,
 	int ret;
...
+	required_mtu = READ_ONCE(mesh_iface->mtu) + max_header_len;
 	...
 	if (hardif_mtu < ETH_MIN_MTU + max_header_len)
 		return -EINVAL;
@@ -727,12 +727,12 @@ int batadv_hardif_enable_interface(struct batadv_hard_iface *hard_iface,
...
@@ -748,19 +748,19 @@ int batadv_hardif_enable_interface(struct batadv_hard_iface *hard_iface,
...
+		batadv_info(hard_iface->mesh_iface,
 			    ...
 			    hard_iface->net_dev->name, hardif_mtu,
 			    required_mtu);
@@ -768,11 +768,11 @@ int batadv_hardif_enable_interface(struct batadv_hard_iface *hard_iface,
...
@@ -781,17 +781,17 @@ int batadv_hardif_enable_interface(struct batadv_hard_iface *hard_iface,
 	return 0;
...
@@ -799,14 +799,14 @@ int batadv_hardif_enable_interface(struct batadv_hard_iface *hard_iface,
  *
...
+		if (hard_iface->mesh_iface != mesh_iface)
 		...
 		count++;
@@ -817,12 +817,12 @@ static size_t batadv_hardif_cnt(const struct net_device *soft_iface)
 }
...
@@ -830,7 +830,7 @@ void batadv_hardif_disable_interface(struct batadv_hard_iface *hard_iface)
 	if (hard_iface->if_status != BATADV_IF_INACTIVE)
 		goto out;
...
+	batadv_info(hard_iface->mesh_iface, "Removing interface: %s\n",
 	...
 	batadv_hardif_put(hard_iface);
@@ -839,7 +839,7 @@ void batadv_hardif_disable_interface(struct batadv_hard_iface *hard_iface)
...
@@ -851,16 +851,16 @@ void batadv_hardif_disable_interface(struct batadv_hard_iface *hard_iface)
 	/* delete all references to this hard_iface */
 	batadv_purge_orig_ref(bat_priv);
 	batadv_purge_outstanding_packets(bat_priv, hard_iface);
-	dev_put(hard_iface->soft_iface);
+	dev_put(hard_iface->mesh_iface);
...
+	hard_iface->mesh_iface = NULL;
 ...
 out:
@@ -884,7 +884,7 @@ batadv_hardif_add_interface(struct net_device *net_dev)
 		goto release_dev;
...
@@ -932,13 +932,13 @@ static void batadv_hardif_remove_interface(struct batadv_hard_iface *hard_iface)
 }
...
@@ -961,8 +961,8 @@ static int batadv_hard_if_event(struct notifier_block *this,
 	struct batadv_hard_iface *primary_if = NULL;
 	struct batadv_priv *bat_priv;
...
@@ -988,8 +988,8 @@ static int batadv_hard_if_event(struct notifier_block *this,
...
+			batadv_update_min_mtu(hard_iface->mesh_iface);
 	...
 	case NETDEV_CHANGEADDR:
 		if (hard_iface->if_status == BATADV_IF_NOT_IN_USE)
@@ -997,7 +997,7 @@ static int batadv_hard_if_event(struct notifier_block *this,
...
index 64f660dbbe542cd63ab640d0cbf485d50b3db9e6..262a7836474277ef2b39e3a2032201cb492b99c9 100644
...
index 7a93a1e94c40eb4e26c9ed3c6c4068d97830aa05..c19d07eeb0701dc907f1770c5792aca9d96e6c8b 100644
...
index 6717c965f0faf5ee3b7fa9536fd94e0d275a8bb0..567afaa8df9989771daa2b71f9a3f9edb7c01914 100644
...
index 333e947afcce7ca4128be8406f23295df723515c..a08132888a3d4f38c0f9b7ef7228f73e4707e211 100644
...
index 964f3088af5b52d3ad1d709fb964dc2c3d79d7a5..427b7504f5b07db89849925c92cfec4f6dc4396d 100644
...
@@ -238,8 +238,8 @@ extern unsigned int batadv_hardif_generation;
...
@@ -345,8 +345,8 @@ static inline bool batadv_has_timed_out(unsigned long timestamp,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  *
@@ -359,8 +359,8 @@ static inline void batadv_add_counter(struct batadv_priv *bat_priv, size_t idx,
 }
...
index 282a8f9b144471b12f62a547b3e57666cbb22c6d..21a099a1e45e53599098ae2959c229c98b3837ba 100644
...
@@ -1055,14 +1055,14 @@ static void batadv_softif_init_early(struct net_device *dev)
 }
...
@@ -1080,7 +1080,7 @@ static int batadv_softif_validate(struct nlattr *tb[], struct nlattr *data[],
 }
...
+ * batadv_meshif_newlink() - pre-initialize and register new batadv link
  ...
  * @tb: IFLA_INFO_DATA netlink attributes
@@ -1089,7 +1089,7 @@ static int batadv_softif_validate(struct nlattr *tb[], struct nlattr *data[],
  *
  * Return: 0 if successful or error otherwise.
  */
...
+static int batadv_meshif_newlink(struct net *src_net, struct net_device *dev,
 				 ...
 				 struct netlink_ext_ack *extack)
 {
@@ -1108,40 +1108,40 @@ static int batadv_softif_newlink(struct net *src_net, struct net_device *dev,
 }
...
+bool batadv_meshif_is_valid(const struct net_device *net_dev)
 {
 	if (net_dev->netdev_ops->ndo_start_xmit == batadv_interface_tx)
 		return true;
@@ -1156,10 +1156,10 @@ static const struct nla_policy batadv_ifla_policy[IFLA_BATADV_MAX + 1] = {
...
index 9f2003f1a4972e331efd02e3f82375563c695a2b..7ba055b2bc269d57719fa5cdd50888155cbd3d44 100644
...
index bcb5fd4e02199a0d47acd9dec298b88a61764527..f26892b362e299c7d13a784a845b781958de98c0 100644
...
@@ -148,16 +148,16 @@ static u8 batadv_mcast_mla_rtr_flags_softif_get_ipv6(struct net_device *dev)
 }
 #else
 static inline u8
...
@@ -169,16 +169,16 @@ batadv_mcast_mla_rtr_flags_softif_get_ipv6(struct net_device *dev)
...
@@ -187,8 +187,8 @@ static u8 batadv_mcast_mla_rtr_flags_softif_get(struct batadv_priv *bat_priv,
...
@@ -202,7 +202,7 @@ static u8 batadv_mcast_mla_rtr_flags_softif_get(struct batadv_priv *bat_priv,
...
+	struct net_device *dev = bat_priv->mesh_iface;
 	...
 	if (!bridge)
@@ -218,8 +218,8 @@ static u8 batadv_mcast_mla_rtr_flags_bridge_get(struct batadv_priv *bat_priv,
...
+	flags &= batadv_mcast_mla_rtr_flags_meshif_get(bat_priv, bridge);
 	...
 	return flags;
@@ -244,7 +244,7 @@ static u8 batadv_mcast_mla_rtr_flags_get(struct batadv_priv *bat_priv,
...
@@ -260,7 +260,7 @@ static u8 batadv_mcast_mla_forw_flags_get(struct batadv_priv *bat_priv)
 		if (hard_iface->if_status != BATADV_IF_ACTIVE)
 			continue;
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * bridge state.
@@ -283,7 +283,7 @@ static u8 batadv_mcast_mla_forw_flags_get(struct batadv_priv *bat_priv)
...
+	struct net_device *dev = bat_priv->mesh_iface;
 	...
 	struct net_device *bridge;
@@ -359,13 +359,13 @@ static bool batadv_mcast_mla_is_duplicate(u8 *mcast_addr,
 }
...
+ * on this kernel on the given mesh interface, dev, in
  ...
  *
@@ -373,7 +373,7 @@ static bool batadv_mcast_mla_is_duplicate(u8 *mcast_addr,
...
+batadv_mcast_mla_meshif_get_ipv4(struct net_device *dev,
 				 ...
 				 struct batadv_mcast_mla_flags *flags)
 {
@@ -425,13 +425,13 @@ batadv_mcast_mla_softif_get_ipv4(struct net_device *dev,
 }
...
+ * on this kernel on the given mesh interface, dev, in
  ...
  * your multicast receiving applications run directly on this node.
  *
@@ -440,7 +440,7 @@ batadv_mcast_mla_softif_get_ipv4(struct net_device *dev,
  */
...
+batadv_mcast_mla_meshif_get_ipv6(struct net_device *dev,
 				 ...
 				 struct batadv_mcast_mla_flags *flags)
 {
@@ -498,7 +498,7 @@ batadv_mcast_mla_softif_get_ipv6(struct net_device *dev,
 }
 #else
 static inline int
-batadv_mcast_mla_softif_get_ipv6(struct net_device *dev,
+batadv_mcast_mla_meshif_get_ipv6(struct net_device *dev,
 				 ...
 				 struct batadv_mcast_mla_flags *flags)
 {
@@ -507,13 +507,13 @@ batadv_mcast_mla_softif_get_ipv6(struct net_device *dev,
 #endif
...
+ * on this kernel on the given mesh interface, dev, in
  ...
  * your multicast receiving applications run directly on this node.
  *
@@ -526,7 +526,7 @@ batadv_mcast_mla_softif_get_ipv6(struct net_device *dev,
  * items added to the mcast_list otherwise.
  */
 static int
...
+batadv_mcast_mla_meshif_get(struct net_device *dev,
 			    ...
 			    struct batadv_mcast_mla_flags *flags)
 {
@@ -536,11 +536,11 @@ batadv_mcast_mla_softif_get(struct net_device *dev,
 	if (bridge)
 		dev = bridge;
...
+	ret6 = batadv_mcast_mla_meshif_get_ipv6(dev, mcast_list, flags);
 	if (ret6 < 0) {
 		ret4 = 0;
 		goto out;
@@ -584,7 +584,7 @@ static void batadv_mcast_mla_br_addr_cpy(char *dst, const struct br_ip *src)
  *
  * Collects multicast addresses of multicast listeners residing
...
@@ -680,7 +680,7 @@ static void batadv_mcast_mla_list_free(struct hlist_head *mcast_list)
...
@@ -712,7 +712,7 @@ static void batadv_mcast_mla_tt_retract(struct batadv_priv *bat_priv,
...
@@ -732,7 +732,7 @@ static void batadv_mcast_mla_tt_add(struct batadv_priv *bat_priv,
...
+		if (!batadv_tt_local_add(bat_priv->mesh_iface,
 					 ...
 					 BATADV_NULL_IFINDEX, BATADV_NO_MARK))
 			continue;
@@ -745,7 +745,7 @@ static void batadv_mcast_mla_tt_add(struct batadv_priv *bat_priv,
 /**
...
@@ -762,7 +762,7 @@ static void batadv_mcast_mla_tt_add(struct batadv_priv *bat_priv,
...
@@ -770,14 +770,14 @@ batadv_mcast_querier_log(struct batadv_priv *bat_priv, char *str_proto,
...
@@ -797,7 +797,7 @@ batadv_mcast_querier_log(struct batadv_priv *bat_priv, char *str_proto,
 /**
...
@@ -806,7 +806,7 @@ batadv_mcast_querier_log(struct batadv_priv *bat_priv, char *str_proto,
...
+ * removed from a mesh interface. And when a bridge is present, it further
  ...
  */
@@ -835,7 +835,7 @@ batadv_mcast_bridge_log(struct batadv_priv *bat_priv,
...
@@ -868,7 +868,7 @@ static void batadv_mcast_flags_log(struct batadv_priv *bat_priv, u8 flags)
...
@@ -897,7 +897,7 @@ batadv_mcast_mla_flags_update(struct batadv_priv *bat_priv,
...
@@ -909,18 +909,18 @@ batadv_mcast_mla_flags_update(struct batadv_priv *bat_priv,
  */
...
@@ -985,7 +985,7 @@ static bool batadv_mcast_is_report_ipv4(struct sk_buff *skb)
 /**
...
@@ -1050,7 +1050,7 @@ static bool batadv_mcast_is_report_ipv6(struct sk_buff *skb)
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @is_unsnoopable: stores whether the destination is snoopable
  * @is_routable: stores whether the destination is routable
@@ -1092,7 +1092,7 @@ static int batadv_mcast_forw_mode_check_ipv6(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @is_unsnoopable: stores whether the destination is snoopable
  * @is_routable: stores whether the destination is routable
@@ -1132,7 +1132,7 @@ static int batadv_mcast_forw_mode_check(struct batadv_priv *bat_priv,
 /**
...
@@ -1155,7 +1155,7 @@ static int batadv_mcast_forw_want_all_ip_count(struct batadv_priv *bat_priv,
...
@@ -1178,7 +1178,7 @@ static int batadv_mcast_forw_rtr_count(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  * @is_routable: stores whether the destination is routable
@@ -1222,7 +1222,7 @@ batadv_mcast_forw_mode_by_count(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  * @is_routable: stores whether the destination is routable
@@ -1267,7 +1267,7 @@ batadv_mcast_forw_mode(struct batadv_priv *bat_priv, struct sk_buff *skb,
...
@@ -1296,7 +1296,7 @@ static int batadv_mcast_forw_send_orig(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  *
@@ -1344,7 +1344,7 @@ batadv_mcast_forw_tt(struct batadv_priv *bat_priv, struct sk_buff *skb,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  *
@@ -1381,7 +1381,7 @@ batadv_mcast_forw_want_all_ipv4(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  *
@@ -1418,7 +1418,7 @@ batadv_mcast_forw_want_all_ipv6(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  *
@@ -1447,7 +1447,7 @@ batadv_mcast_forw_want_all(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  *
@@ -1484,7 +1484,7 @@ batadv_mcast_forw_want_all_rtr4(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  *
@@ -1521,7 +1521,7 @@ batadv_mcast_forw_want_all_rtr6(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  *
@@ -1550,7 +1550,7 @@ batadv_mcast_forw_want_rtr(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: the vlan identifier
  * @is_routable: stores whether the destination is routable
@@ -1598,7 +1598,7 @@ int batadv_mcast_forw_send(struct batadv_priv *bat_priv, struct sk_buff *skb,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  *
@@ -1644,7 +1644,7 @@ static void batadv_mcast_want_unsnoop_update(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @mcast_flags: flags indicating the new multicast state
  *
@@ -1689,7 +1689,7 @@ static void batadv_mcast_want_ipv4_update(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @mcast_flags: flags indicating the new multicast state
  *
@@ -1734,7 +1734,7 @@ static void batadv_mcast_want_ipv6_update(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @mcast_flags: flags indicating the new multicast state
  *
@@ -1779,7 +1779,7 @@ static void batadv_mcast_want_rtr4_update(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @mcast_flags: flags indicating the new multicast state
  *
@@ -1824,7 +1824,7 @@ static void batadv_mcast_want_rtr6_update(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @mcast_flags: flags indicating the new multicast state
  *
@@ -1880,7 +1880,7 @@ batadv_mcast_tvlv_flags_get(bool enabled, void *tvlv_value, u16 tvlv_value_len)
...
@@ -1923,7 +1923,7 @@ static void batadv_mcast_tvlv_ogm_handler(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
 ...
 {
@@ -1942,7 +1942,7 @@ void batadv_mcast_init(struct batadv_priv *bat_priv)
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  */
@@ -2068,7 +2068,7 @@ batadv_mcast_flags_dump_bucket(struct sk_buff *msg, u32 portid,
  * @msg: buffer for the message
  * @portid: netlink port
  * @cb: Control block containing additional options
- * @bat_priv: the bat priv with all the soft interface information
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  *
@@ -2111,15 +2111,15 @@ batadv_mcast_netlink_get_primary(struct netlink_callback *cb,
 				 struct batadv_hard_iface **primary_if)
 {
...
@@ -2128,7 +2128,7 @@ batadv_mcast_netlink_get_primary(struct netlink_callback *cb,
 	}
...
@@ -2158,7 +2158,7 @@ int batadv_mcast_flags_dump(struct sk_buff *msg, struct netlink_callback *cb)
 	if (ret)
 		return ret;
...
+	bat_priv = netdev_priv(primary_if->mesh_iface);
 	...
 	batadv_hardif_put(primary_if);
@@ -2167,7 +2167,7 @@ int batadv_mcast_flags_dump(struct sk_buff *msg, struct netlink_callback *cb)
...
index fafd6ba8c056d900f2f3976b289a77dedf44284d..b8668a80b94a1e6b7fd06d98531e34b505fabf38 100644
...
index c37e0995f67e07948d800187ae1a954ecdd50045..1836f64ce8aa247331b003f69c1212f8128baf33 100644
...
index 2097c2ae98f16a5119a0c4255e48a3cf4d20cca7..fe4548b974bb095410bd6389751797d7d012ca85 100644
...
index 71ebd0284f95d229aa9ff4e9778c23354d51c856..9f56308779cc3a6bb52e0cb29a7daec95fdcb469 100644
...
index bcc2e20e0cd6c7077f3d148f8c77b0947561ed3d..d9cfc5c6b20884c8ee6821a6e570091499e5607a 100644
...
index f1061985149fc5cd31d2752e8dcebf4a9ff33926..35d8c578399985760c28f09de9629a57212d2f27 100644
...
index 0379b126865d7c07b84c08c93eca38279fe6df9c..85478fdc8ce88e2825692d3dcbfbfbacb30d6128 100644
...
index 08af251b765c2b077eecb3ce86defbde8bac95e8..3415afec4a0c2a7e3be508a6b10bcec35a13144e 100644
...
index 7f3dd3c393e07aca046541d923aaaedd0e67dd5a..9fb14e40e15627ef874946c9efb2abbcee060248 100644
...
index 2fa3457cdcca767d91a5e615d4c9a106d14cae4d..defe727375b9b51404e6717ee6d1458e1641a4cf 100644
...
index 7e36108bb4eff860684089408dfd9add70e567a0..23cb44185a5ceb2ad836ffa1e8446e8c3a41d02e 100644
...
@@ -189,7 +189,7 @@ batadv_tt_hash_find(struct batadv_hashtable *hash, const u8 *addr,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
  *
@@ -214,7 +214,7 @@ batadv_tt_local_hash_find(struct batadv_priv *bat_priv, const u8 *addr,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
  *
@@ -249,7 +249,7 @@ static void batadv_tt_local_entry_release(struct kref *ref)
...
@@ -296,7 +296,7 @@ void batadv_tt_global_entry_release(struct kref *ref)
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
  *
@@ -322,28 +322,28 @@ int batadv_tt_global_hash_count(struct batadv_priv *bat_priv,
 /**
...
@@ -355,7 +355,7 @@ static void batadv_tt_local_size_inc(struct batadv_priv *bat_priv,
 /**
...
@@ -452,7 +452,7 @@ batadv_tt_orig_list_entry_put(struct batadv_tt_orig_list_entry *orig_entry)
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  */
@@ -544,7 +544,7 @@ static u16 batadv_tt_entries(u16 tt_len)
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  */
@@ -552,11 +552,11 @@ static int batadv_tt_local_table_transmit_size(struct batadv_priv *bat_priv)
 {
 	u16 num_vlan = 0;
...
@@ -616,7 +616,7 @@ static void batadv_tt_global_free(struct batadv_priv *bat_priv,
 /**
...
@@ -626,14 +626,14 @@ static void batadv_tt_global_free(struct batadv_priv *bat_priv,
  *
...
+	struct batadv_meshif_vlan *vlan;
 	...
 	struct hlist_head *head;
@@ -690,7 +690,7 @@ bool batadv_tt_local_add(struct net_device *soft_iface, const u8 *addr,
...
+		net_ratelimited_function(batadv_info, mesh_iface,
 		...
 		goto out;
@@ -701,9 +701,9 @@ bool batadv_tt_local_add(struct net_device *soft_iface, const u8 *addr,
 		goto out;
...
@@ -733,7 +733,7 @@ bool batadv_tt_local_add(struct net_device *soft_iface, const u8 *addr,
...
@@ -889,7 +889,7 @@ batadv_tt_prepare_tvlv_global_data(struct batadv_orig_node *orig_node,
 /**
...
@@ -911,7 +911,7 @@ batadv_tt_prepare_tvlv_local_data(struct batadv_priv *bat_priv,
 				  s32 *tt_len)
 {
...
+	struct batadv_meshif_vlan *vlan;
 	...
 	u16 vlan_entries = 0;
 	u16 total_entries = 0;
@@ -919,8 +919,8 @@ batadv_tt_prepare_tvlv_local_data(struct batadv_priv *bat_priv,
 	u8 *tt_change_ptr;
 	int change_offset;
...
+	hlist_for_each_entry(vlan, &bat_priv->meshif_vlan_list, list) {
 		...
 		if (vlan_entries < 1)
 			continue;
@@ -949,7 +949,7 @@ batadv_tt_prepare_tvlv_local_data(struct batadv_priv *bat_priv,
...
+	hlist_for_each_entry(vlan, &bat_priv->meshif_vlan_list, list) {
 		...
 		if (vlan_entries < 1)
 			continue;
@@ -965,14 +965,14 @@ batadv_tt_prepare_tvlv_local_data(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
 ...
 {
@@ -996,7 +996,7 @@ static void batadv_tt_tvlv_container_update(struct batadv_priv *bat_priv)
...
+	if (tt_diff_len > bat_priv->mesh_iface->mtu) {
 		...
 		drop_changes = true;
@@ -1065,7 +1065,7 @@ static void batadv_tt_tvlv_container_update(struct batadv_priv *bat_priv)
  * @msg :Netlink message to dump into
  * @portid: Port making netlink request
  * @cb: Control block containing additional options
- * @bat_priv: The bat priv with all the soft interface information
+ * @bat_priv: The bat priv with all the mesh interface information
  ...
  *
  * Return: Error code, or 0 on success
@@ -1077,7 +1077,7 @@ batadv_tt_local_dump_entry(struct sk_buff *msg, u32 portid,
...
+	struct batadv_meshif_vlan *vlan;
 	...
 	u32 crc;
@@ -1085,13 +1085,13 @@ batadv_tt_local_dump_entry(struct sk_buff *msg, u32 portid,
...
@@ -1124,7 +1124,7 @@ batadv_tt_local_dump_entry(struct sk_buff *msg, u32 portid,
  * @msg: Netlink message to dump into
  * @portid: Port making netlink request
  * @cb: Control block containing additional options
- * @bat_priv: The bat priv with all the soft interface information
+ * @bat_priv: The bat priv with all the mesh interface information
  ...
  * @idx_s: Number of entries to skip
@@ -1170,7 +1170,7 @@ batadv_tt_local_dump_bucket(struct sk_buff *msg, u32 portid,
  */
...
+	struct net_device *mesh_iface;
 	...
 	struct batadv_hard_iface *primary_if = NULL;
 	struct batadv_hashtable *hash;
@@ -1179,11 +1179,11 @@ int batadv_tt_local_dump(struct sk_buff *msg, struct netlink_callback *cb)
 	int idx = cb->args[1];
 	int portid = NETLINK_CB(cb->skb).portid;
...
+	bat_priv = netdev_priv(mesh_iface);
 	...
 	primary_if = batadv_primary_if_get_selected(bat_priv);
 	if (!primary_if || primary_if->if_status != BATADV_IF_ACTIVE) {
@@ -1205,7 +1205,7 @@ int batadv_tt_local_dump(struct sk_buff *msg, struct netlink_callback *cb)
...
+	dev_put(mesh_iface);
 	...
 	cb->args[0] = bucket;
 	cb->args[1] = idx;
@@ -1234,7 +1234,7 @@ batadv_tt_local_set_pending(struct batadv_priv *bat_priv,
...
@@ -1299,7 +1299,7 @@ u16 batadv_tt_local_remove(struct batadv_priv *bat_priv, const u8 *addr,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  *  inactive or not
@@ -1334,7 +1334,7 @@ static void batadv_tt_local_purge_list(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  *  inactive or not
  */
@@ -1569,7 +1569,7 @@ batadv_tt_global_orig_entry_add(struct batadv_tt_global_entry *tt_global,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
@@ -1742,7 +1742,7 @@ static bool batadv_tt_global_add(struct batadv_priv *bat_priv,
...
@@ -1849,7 +1849,7 @@ batadv_tt_global_dump_subentry(struct sk_buff *msg, u32 portid, u32 seq,
  * @msg: Netlink message to dump into
  * @portid: Port making netlink request
  * @seq: Sequence number of netlink message
- * @bat_priv: The bat priv with all the soft interface information
+ * @bat_priv: The bat priv with all the mesh interface information
  ...
  *
@@ -1894,7 +1894,7 @@ batadv_tt_global_dump_entry(struct sk_buff *msg, u32 portid, u32 seq,
  * @msg: Netlink message to dump into
  * @portid: Port making netlink request
  * @seq: Sequence number of netlink message
- * @bat_priv: The bat priv with all the soft interface information
...
@@ -1937,7 +1937,7 @@ batadv_tt_global_dump_bucket(struct sk_buff *msg, u32 portid, u32 seq,
  */
...
+	struct net_device *mesh_iface;
 	...
 	struct batadv_hard_iface *primary_if = NULL;
 	struct batadv_hashtable *hash;
@@ -1948,11 +1948,11 @@ int batadv_tt_global_dump(struct sk_buff *msg, struct netlink_callback *cb)
 	int sub = cb->args[2];
 	int portid = NETLINK_CB(cb->skb).portid;
...
+	bat_priv = netdev_priv(mesh_iface);
 	...
 	primary_if = batadv_primary_if_get_selected(bat_priv);
 	if (!primary_if || primary_if->if_status != BATADV_IF_ACTIVE) {
@@ -1977,7 +1977,7 @@ int batadv_tt_global_dump(struct sk_buff *msg, struct netlink_callback *cb)
...
+	dev_put(mesh_iface);
 	...
 	cb->args[0] = bucket;
 	cb->args[1] = idx;
@@ -2030,7 +2030,7 @@ batadv_tt_global_del_orig_list(struct batadv_tt_global_entry *tt_global_entry)
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @orig_node: the originator announcing the client
  * @message: message to append to the log on deletion
@@ -2109,7 +2109,7 @@ batadv_tt_global_del_roaming(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
@@ -2174,7 +2174,7 @@ static void batadv_tt_global_del(struct batadv_priv *bat_priv,
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  *  removed
@@ -2345,7 +2345,7 @@ _batadv_is_ap_isolated(struct batadv_tt_local_entry *tt_local_entry,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
@@ -2404,7 +2404,7 @@ struct batadv_orig_node *batadv_transtable_search(struct batadv_priv *bat_priv,
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  *
@@ -2498,7 +2498,7 @@ static u32 batadv_tt_global_crc(struct batadv_priv *bat_priv,
...
@@ -2633,7 +2633,7 @@ static void batadv_tt_req_purge(struct batadv_priv *bat_priv)
...
@@ -2729,7 +2729,7 @@ static bool batadv_tt_global_valid(const void *entry_ptr,
 /**
...
@@ -2850,15 +2850,15 @@ static bool batadv_tt_global_check_crc(struct batadv_orig_node *orig_node,
...
+	hlist_for_each_entry_rcu(vlan, &bat_priv->meshif_vlan_list, list) {
 	...
 	rcu_read_unlock();
@@ -2866,7 +2866,7 @@ static void batadv_tt_local_update_crc(struct batadv_priv *bat_priv)
...
@@ -2893,7 +2893,7 @@ static void batadv_tt_global_update_crc(struct batadv_priv *bat_priv,
...
@@ -2978,7 +2978,7 @@ static bool batadv_send_tt_request(struct batadv_priv *bat_priv,
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @req_src: mac address of tt request sender
  *
@@ -3225,7 +3225,7 @@ static bool batadv_send_my_tt_response(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @req_src: mac address of tt request sender
  * @req_dst: mac address of tt request recipient
@@ -3320,7 +3320,7 @@ static void batadv_tt_update_changes(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
  *
@@ -3349,7 +3349,7 @@ bool batadv_is_my_client(struct batadv_priv *bat_priv, const u8 *addr,
...
@@ -3437,7 +3437,7 @@ static void batadv_tt_roam_purge(struct batadv_priv *bat_priv)
...
@@ -3492,7 +3492,7 @@ static bool batadv_tt_check_roam_count(struct batadv_priv *bat_priv, u8 *client)
...
@@ -3556,8 +3556,8 @@ static void batadv_tt_purge(struct work_struct *work)
 }
...
+ * @bat_priv: the bat priv with all the mesh interface information
 ...
 {
@@ -3580,7 +3580,7 @@ void batadv_tt_free(struct batadv_priv *bat_priv)
 /**
...
@@ -3666,7 +3666,7 @@ static void batadv_tt_local_purge_pending_clients(struct batadv_priv *bat_priv)
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  */
@@ -3699,7 +3699,7 @@ static void batadv_tt_local_commit_changes_nolock(struct batadv_priv *bat_priv)
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
 ...
 {
@@ -3710,7 +3710,7 @@ void batadv_tt_local_commit_changes(struct batadv_priv *bat_priv)
...
@@ -3722,10 +3722,10 @@ bool batadv_is_ap_isolated(struct batadv_priv *bat_priv, u8 *src, u8 *dst,
 {
...
@@ -3747,14 +3747,14 @@ bool batadv_is_ap_isolated(struct batadv_priv *bat_priv, u8 *src, u8 *dst,
 local_entry_put:
...
@@ -3838,7 +3838,7 @@ static void batadv_tt_update_orig(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
  *
@@ -3864,7 +3864,7 @@ bool batadv_tt_global_client_is_roaming(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @vid: VLAN identifier
  *
@@ -3890,7 +3890,7 @@ bool batadv_tt_local_client_is_roaming(struct batadv_priv *bat_priv,
...
@@ -3923,14 +3923,14 @@ bool batadv_tt_add_temporary_global_entry(struct batadv_priv *bat_priv,
 /**
...
+	struct batadv_priv *bat_priv = netdev_priv(mesh_iface);
 	...
 	bool reduced = false;
@@ -3947,7 +3947,7 @@ void batadv_tt_local_resize_to_mtu(struct net_device *soft_iface)
...
@@ -3963,7 +3963,7 @@ void batadv_tt_local_resize_to_mtu(struct net_device *soft_iface)
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @flags: flags indicating the tvlv state (see batadv_tvlv_handler_flags)
  * @tvlv_value: tvlv buffer containing the gateway data
@@ -4002,7 +4002,7 @@ static void batadv_tt_tvlv_ogm_handler_v1(struct batadv_priv *bat_priv,
 /**
...
@@ -4084,7 +4084,7 @@ static int batadv_tt_tvlv_unicast_handler_v1(struct batadv_priv *bat_priv,
 /**
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * @dst: mac address of tt tvlv recipient
  * @tvlv_value: tvlv buffer containing the tt data
@@ -4133,7 +4133,7 @@ static int batadv_roam_tvlv_unicast_handler_v1(struct batadv_priv *bat_priv,
...
+ * @bat_priv: the bat priv with all the mesh interface information
  ...
  * Return: 0 on success or negative error number in case of failure.
  */
@@ -4171,7 +4171,7 @@ int batadv_tt_init(struct batadv_priv *bat_priv)
...
index d18740d9a22b65336041e8d4330cbb080e7c8063..618d9dbca5eac48c06f99922ce5902ecce500821 100644
...
index 2a583215d439bd72208fbff13ee82030b6d062d6..76dff1f9c559a46e88b3ecc3837f29f671d5a8b2 100644
...
index fe89f08533fe694e137bf31594c60915d4783c7a..9fc236317a910ae7ce0bbb5e2ba01f689584bd91 100644
...
@@ -899,13 +899,13 @@ enum batadv_counters {
...
@@ -1264,7 +1264,7 @@ struct batadv_mcast_mla_flags {
...
@@ -1400,7 +1400,7 @@ struct batadv_priv_nc {
 	/**
...
@@ -1553,9 +1553,9 @@ struct batadv_tp_vars {
 };
...
@@ -1568,7 +1568,7 @@ struct batadv_softif_vlan {
...
+	/** @list: list node for &bat_priv.meshif_vlan_list */
 	...
 	/**
@@ -1581,7 +1581,7 @@ struct batadv_softif_vlan {
 };
...
@@ -1610,8 +1610,8 @@ struct batadv_priv {
 	 */
 	atomic_t mesh_state;
...
@@ -1760,13 +1760,13 @@ struct batadv_priv {
 	struct batadv_algo_ops *algo_ops;
...
@@ -1808,7 +1808,7 @@ struct batadv_priv {
 #endif /* CONFIG_BATMAN_ADV_NC */
...
@@ -1831,7 +1831,7 @@ struct batadv_bla_backbone_gw {
...
@@ -1936,8 +1936,8 @@ struct batadv_tt_local_entry {
...
change-id: 20250202-meshif-bddebde268f7

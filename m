...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A6BE3496D6
	for <lists+b.a.t.m.a.n@lfdr.de>; Thu, 25 Mar 2021 17:31:49 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 6433283E0C;
	Thu, 25 Mar 2021 17:31:48 +0100 (CET)
Received: from mail-pf1-x42e.google.com (mail-pf1-x42e.google.com [IPv6:2607:f8b0:4864:20::42e])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 0DD9683DCF
	for <b.a.t.m.a.n@lists.open-mesh.org>; Thu, 25 Mar 2021 17:17:38 +0100 (CET)
Received: by mail-pf1-x42e.google.com with SMTP id g15so2577801pfq.3
        for <b.a.t.m.a.n@lists.open-mesh.org>; Thu, 25 Mar 2021 09:17:37 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=itA6cBW70QcpHwdijhOyiNQnZri5yCqO9XV9od2wLUI=;
        b=
X-Gm-Message-State: AOAM531ONAgSdALJvud/tmQRybaGIqk29gZGB/TcVrfBK32MTAkLf6xQ
	BhlBZIU/0tTISRhdbtvslH0=
...
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1616689058; a=rsa-sha256;
	cv=none;
	b=Jjyr/7+KYhVHUP7kDO1h88w8IjYrWJbloyJH/sMqvYM6ADCkFYWXQkyLIRTr9EUAGxFJaP
	kl1jpKfWoxQr+Fc4AOTL9RX1G1H1fkCsXXbT35gsjKgGL7rg2Bi9ZvaqgnBK52HH4KM9n/
	VsB+gpP2Ts/JwdV38TTfcLJfnxozwmo=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=gmail.com header.s=20161025 header.b="nuAyTbo/";
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1616689058;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:in-reply-to:in-reply-to:references:references:  dkim-signature;
	bh=itA6cBW70QcpHwdijhOyiNQnZri5yCqO9XV9od2wLUI=;
	b=0u8xLkGagbiR7YU/NTeAYmrcYBUXiwgOMdMMr/Ve2QiS840XA/Jk/QIiTs9sh8Oz2vOHwb
	BSpdPSBOPS3H9ukxiNnPFQDoytKbEH4EABFQygG6IYjIVqb2riukM41YSIBqDVkqiaMig6
	DEFEtDDpE4BSUjHEzhkzC0mgXIsl6IQ=
X-MailFrom: ap420073@gmail.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-b.a.t.m.a.n.lists.open-mesh.org-0; header-match-b.a.t.m.a.n.lists.open-mesh.org-1
Message-ID-Hash: JGR3M2LNV7OBVDPQV6JC77H5XSDY5JR6
X-Message-ID-Hash: JGR3M2LNV7OBVDPQV6JC77H5XSDY5JR6
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/JGR3M2LNV7OBVDPQV6JC77H5XSDY5JR6/>

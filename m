...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 1961F2C503C
	for <lists+b.a.t.m.a.n@lfdr.de>; Thu, 26 Nov 2020 09:22:10 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id C83FC805CE;
	Thu, 26 Nov 2020 09:22:08 +0100 (CET)
Received: from dvalin.narfation.org (dvalin.narfation.org [213.160.73.56])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 0CCCD802D7
	for <b.a.t.m.a.n@lists.open-mesh.org>; Thu, 26 Nov 2020 09:22:05 +0100 (CET)
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1606378926;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=2/Ccyeyjwu9fU4cIT93gVE0sNF6DivFcl1DKMQ5D4Kk=;
	b=2oGRGOdW2bHWSj0vT+F6ManGQx4JcmxFgdP1hSvlf1YbaNBHT223rP51Bk/4ERy22vE+LS
	dVdrLMc2u7B4shGCPDLFqQV8MMBPWmfx9kX4MuvmwzIRM719xDhBe5LNKBBaqDl11WAYuJ
	hW5DBN4L2sU9FgWGBYL9/PBkIKs3bpw=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1606378926; a=rsa-sha256;
	cv=none;
	b=c4L7BeSKQZ1uTgiMZkdw3TDfoLOD8I1hMb0ywCFvIQPi8dA0MZz1+9K9P2/7c+UbaUPJQD
	9n1WN/sQoaQBqSu3lJDA/VP5pYM/Vr79vEZ5s+Tk9PUj3GKW/gkD8A00f3UpmfsygZPvwA
	rSn4NQOZEJVZn1kbUlN8uudeH+q3o2g=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=narfation.org header.s=20121 header.b=nAr2JftJ;
	spf=pass (diktynna.open-mesh.org: domain of sven@narfation.org designates 213.160.73.56 as permitted sender) smtp.mailfrom=sven@narfation.org
Message-ID-Hash: ZLUYIMHVBSVUSND2QIR6XNLE3C3FOGYV
X-Message-ID-Hash: ZLUYIMHVBSVUSND2QIR6XNLE3C3FOGYV
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/ZLUYIMHVBSVUSND2QIR6XNLE3C3FOGYV/>

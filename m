...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id F0B9036CB43
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 27 Apr 2021 20:45:51 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id A216F80C1F;
	Tue, 27 Apr 2021 20:45:50 +0200 (CEST)
Received: from mail.aperture-lab.de (mail.aperture-lab.de [IPv6:2a01:4f8:c2c:665b::1])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id C6C6880040
	for <b.a.t.m.a.n@lists.open-mesh.org>; Tue, 27 Apr 2021 20:45:43 +0200 (CEST)
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon) with ESMTPSA id A00413EB2E;
	Tue, 27 Apr 2021 20:45:41 +0200 (CEST)
From: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
To: b.a.t.m.a.n@lists.open-mesh.org
Cc: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
Subject: [PATCH v2] batman-adv: bcast: queue per interface, if needed
Date: Tue, 27 Apr 2021 20:45:27 +0200
Message-Id: <20210427184527.9889-1-linus.luessing@c0d3.blue>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
X-Last-TLS-Session-Version: TLSv1.2
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1619549146; a=rsa-sha256;
	cv=none;
	b=tq1Ca6htYPceekEKADO9dvlfrU/KQgN4HgX1m56rpP2TM1mOtOc8AcWVGgopaPl17f3IRF
	gthd5I1FBSQa26Q7WFDicJY8WemW+Lh41nxuHX2BcCP55Fk48CEVWfPlLJuD+i9W47Ukq2
	Ze1NDry6YWO7+TwDSkJQXspJH0aUiBM=
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1619549146;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding;
	bh=vLcpx7TAbhgtiGsctLmPFogK+/rh8etHa+mkEtdjBdA=;
	b=rrGcA+3219MdXiNLQwBeav4SLWRa2s5qf3eqZwU/169nuIXKJ/ywRzD6aieqspznYvKDUs
	Pq4mycBtoO4i0KhN6d0gkuSpr1yqP2ZBKDNMa1jr7jnphnNrZB1pprV36TJjSJ0Zel4jkq
	bgvCkGFgt/a3hPB/U2t3IND6q9tPGIk=
Content-Transfer-Encoding: quoted-printable
Message-ID-Hash: DXOX3567FLZM64IEEIWRVAVN3JWFTJET
X-Message-ID-Hash: DXOX3567FLZM64IEEIWRVAVN3JWFTJET
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/DXOX3567FLZM64IEEIWRVAVN3JWFTJET/>
...
@@ -737,57 +737,52 @@ void batadv_forw_packet_ogmv1_queue(struct batadv_p=
riv *bat_priv,
 }
=20
 /**
...
=20
 err_packet_free:
@@ -796,10 +791,234 @@ int batadv_add_bcast_packet_to_list(struct batadv_=
priv *bat_priv,
...
rovided
  * interface.
@@ -811,28 +1030,20 @@ int batadv_add_bcast_packet_to_list(struct batadv_=
priv *bat_priv,
...
=20
 /**
@@ -843,30 +1054,30 @@ batadv_forw_packet_bcasts_inc(struct batadv_forw_p=
acket *forw_packet)
  */
...
=20
 ...
 {
 		dropped =3D true;
@@ -878,76 +1089,15 @@ static void batadv_send_outstanding_bcast_packet(s=

...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FF003F14F7
	for <lists+b.a.t.m.a.n@lfdr.de>; Thu, 19 Aug 2021 10:15:55 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 4613980FA6;
	Thu, 19 Aug 2021 10:15:54 +0200 (CEST)
Received: from mail-il1-f198.google.com (mail-il1-f198.google.com [209.85.166.198])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 4633F804C3
	for <b.a.t.m.a.n@lists.open-mesh.org>; Thu, 19 Aug 2021 10:15:50 +0200 (CEST)
Received: by mail-il1-f198.google.com with SMTP id c4-20020a056e020cc4b02902242bd90889so2811956ilj.20
        for <b.a.t.m.a.n@lists.open-mesh.org>; Thu, 19 Aug 2021 01:15:50 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:date:message-id:subject:from:to;
        bh=VLMWKMsTun8f1GPH/VyUO/C5MN+JOvRdiw23QeqF200=;
        b=
X-Gm-Message-State: AOAM533awi7tOnxVqbBgw7Gsez90s580vFlbUmWjMyByNaJ+A7cg9OH+
	spX3bIDsX6SHacMz7kcY3yzi2OmCzkW0NYdGi7oF33UgsezY
...
To: a@unstable.cc, adilger.kernel@dilger.ca, arnd@arndb.de,
	b.a.t.m.a.n@lists.open-mesh.org, christian@brauner.io, davem@davemloft.net,
...
ARC-Authentication-Results: i=1;
	...
	dkim=none;
	spf=pass (diktynna.open-mesh.org: domain of 36hEeYQkbAJUHNO9zAA3GzEE72.5DD5A3JH3G1DCI3CI.1DB@M3KW2WVRGUFZ5GODRSRYTGD7.apphosting.bounces.google.com designates 209.85.166.198 as permitted sender) smtp.mailfrom=36hEeYQkbAJUHNO9zAA3GzEE72.5DD5A3JH3G1DCI3CI.1DB@M3KW2WVRGUFZ5GODRSRYTGD7.apphosting.bounces.google.com
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1629360950; a=rsa-sha256;
	cv=none;
	b=QKL5ndX/MdM+3Eftbg6uSEuz0TCeJ/Me6Op1VGaU8yMNyux+gLvUjYoSG5+g0ygBHxxbAA
	M9yIMQf9pFl80vEzFuNxrXU4t2WtlRBP+Rqx5gzimM9nalNmxo2Pg4ibKbwfdzQ2n/3rZv
	QiOi2mNrnQp5us0xGZdihuEkxMv9czo=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1629360950;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:mime-version:mime-version:content-type:content-type;
	bh=VLMWKMsTun8f1GPH/VyUO/C5MN+JOvRdiw23QeqF200=;
	b=09CJqzEWTE+rZorbn5VRuhBQ9V1ImorJXwQMK+6QZGztlqZHO87AMQ5OUCXZtsqzq/pF0t
	3XcfvxlGUqCmK6p3WHCH10JEGceJBtqT3eDiosu7+dxaaeVmH4Rnk6c6t7W5kpxvYzN03a
	UB9NpLljIQfj1qxi2+qXQ3JmFWNorHk=
Message-ID-Hash: TFH7NWSLBRZDAD2S4KW6JKGZJPVUACJS
X-Message-ID-Hash: TFH7NWSLBRZDAD2S4KW6JKGZJPVUACJS
X-MailFrom: 36hEeYQkbAJUHNO9zAA3GzEE72.5DD5A3JH3G1DCI3CI.1DB@M3KW2WVRGUFZ5GODRSRYTGD7.apphosting.bounces.google.com
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/TFH7NWSLBRZDAD2S4KW6JKGZJPVUACJS/>

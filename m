...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 05FF537A573
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 11 May 2021 13:09:00 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id B8A3783F88;
	Tue, 11 May 2021 13:08:58 +0200 (CEST)
Received: from NAM11-BN8-obe.outbound.protection.outlook.com (mail-bn8nam11on20610.outbound.protection.outlook.com [IPv6:2a01:111:f400:7eae::610])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 009B3803FD
	for <b.a.t.m.a.n@lists.open-mesh.org>; Tue, 11 May 2021 11:16:24 +0200 (CEST)
...
X-MS-Exchange-AntiSpam-MessageData: 
	=?utf-8?B?dHpOUTcxYzZVYUFNeUhVZGJOa3ErSGN6ZmxQWGxpbnl0d1pBVlY5UmlWSmxl?=
...
ARC-Seal: i=2; s=20121; d=open-mesh.org; t=1620724585; a=rsa-sha256;
	cv=pass;
	b=ITkKgcMlY0uvqY7H7GjV2LxdjMKuyp8DvuSWLHwsVJiXXnMSbLOLq4s42ZVDiMLW7jV9wZ
	enC08fj5OhALHRTDhdd8ZmJe18hG5ElMY9j0kYOP/8AmCqrknNk7TgN/If24xCYhwRfgbS
	FXvNqN2EQ5tL+NyaVOltdHHHuV+0fjU=
ARC-Authentication-Results: i=2;
	diktynna.open-mesh.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=mxjAl1nP;
	arc=pass ("microsoft.com:s=arcselector9901:i=1");
	spf=softfail (diktynna.open-mesh.org: 2a01:111:f400:7eae::610 is neither permitted nor denied by domain of nikolay@nvidia.com) smtp.mailfrom=nikolay@nvidia.com
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1620724585;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=J4XkyP1TlrLUN1TwDhG55u0q1y3824PO14R1vE3XBGw=;
	b=gEJXcfXneeicxqN6jAF5CpDRxP/h0YmDtglGOjY08xv/b4ZYqY9ZCA8Ygqpnh7/Pwn5I2y
	o7mhMdafGlQChSmA+X1G8v8/ynbnQ6CjFzJ5stTpDOkohnLGEK7g94irNEph68utad/zPX
	2NpYd7fG97kxEL5w3PLOZRPL4cMsLls=
Content-Transfer-Encoding: quoted-printable
X-MailFrom: nikolay@nvidia.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-b.a.t.m.a.n.lists.open-mesh.org-0; header-match-b.a.t.m.a.n.lists.open-mesh.org-1
Message-ID-Hash: JSCNTFN7FGUHCK66YUXYQKHQJTI73XYA
X-Message-ID-Hash: JSCNTFN7FGUHCK66YUXYQKHQJTI73XYA
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/JSCNTFN7FGUHCK66YUXYQKHQJTI73XYA/>
...
> @@ -1391,7 +1391,8 @@ static void br_multicast_local_router_expired(str=
uct timer_list *t)
...
> @@ -3622,7 +3623,7 @@ bool br_multicast_router(const struct net_device =
*dev)
>  	bool is_router;
> =20
...
> @@ -864,11 +864,39 @@ static inline bool br_group_is_l2(const struct br=
_ip *group)

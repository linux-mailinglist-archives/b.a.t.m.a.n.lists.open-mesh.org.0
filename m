...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id 775A626FE1D
	for <lists+b.a.t.m.a.n@lfdr.de>; Fri, 18 Sep 2020 15:20:23 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id B13A880852;
	Fri, 18 Sep 2020 15:20:14 +0200 (CEST)
Received: from simonwunderlich.de (simonwunderlich.de [79.140.42.25])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id BC39E800F2
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	...
	bh=DnIPs/8RvvoGyAAYXeO42RFSpAthFvHmjFz9mN3B0Uk=;
	b=Hl4SjiFOcLbzjayYDtSZE6CqicepLLgLBcpRkCxfRoxBMmBA6MV2RNHhzG/xQuUxV1pJ3B
	NAlYg6nOX4hB4z0+UqD8Zp+rVPUtOj/KO4UJ02KGvLvRWSzcnAGWRIVhHhrWABSbASR6mA
	I+XNKGMRrqWP/v8ZQoujP6SaXLskNlk=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1600435200; a=rsa-sha256;
	cv=none;
	b=l93LZYmKQSBqY/LItJNScCMnbEvoc+rt/p2nK43qWFg+++Q5cwqeg8fys/23YtFEAC+m5D
	6KQOVgCeVgbCWbcYYj0faAeNJ5+vIzxhtey3GNRh5HqdPEACo0PbRh6aFjj2JE3Xi+Ix9S
	PPb+6qGFXJyrVIMTC0VMANqBMdpP+MU=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=none;
	spf=pass (diktynna.open-mesh.org: domain of sw@simonwunderlich.de designates 79.140.42.25 as permitted sender) smtp.mailfrom=sw@simonwunderlich.de
Content-Transfer-Encoding: quoted-printable
Message-ID-Hash: GPSVC3BJYG2R36X56W5TPOKCVYOJESQG
X-Message-ID-Hash: GPSVC3BJYG2R36X56W5TPOKCVYOJESQG
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/GPSVC3BJYG2R36X56W5TPOKCVYOJESQG/>
...
@@ -1814,7 +1814,7 @@ batadv_bla_loopdetect_check(struct batadv_priv *bat=
...
@@ -1826,7 +1826,7 @@ batadv_bla_loopdetect_check(struct batadv_priv *bat=
_priv, struct sk_buff *skb,
...
@@ -1848,9 +1848,24 @@ bool batadv_bla_rx(struct batadv_priv *bat_priv, s=
truct sk_buff *skb,
 		goto handled;
=20
...
@@ -1885,13 +1900,14 @@ bool batadv_bla_rx(struct batadv_priv *bat_priv, =
struct sk_buff *skb,
 		goto allow;
 	}
=20

...
Received: from open-mesh.org (open-mesh.org [IPv6:2a01:4f8:141:3341:78:46:248:236])
	by mail.lfdr.de (Postfix) with ESMTPS id E968A63A2A
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue,  9 Jul 2019 19:27:53 +0200 (CEST)
Received: from open-mesh.org (localhost [IPv6:::1])
	by open-mesh.org (Postfix) with ESMTP id 5C96D8255F;
	Tue,  9 Jul 2019 19:27:19 +0200 (CEST)
Received: from dvalin.narfation.org (dvalin.narfation.org [213.160.73.56])
 by open-mesh.org (Postfix) with ESMTPS id B57CB823E0
 for <b.a.t.m.a.n@lists.open-mesh.org>; Tue,  9 Jul 2019 19:27:15 +0200 (CEST)
Received: from sven-desktop.home.narfation.org (unknown
 [IPv6:2a00:1ca0:1480:f9fc::4065])
 by dvalin.narfation.org (Postfix) with ESMTPSA id 21DF31FDB9;
 Tue,  9 Jul 2019 17:27:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=narfation.org;
 s=20121; t=1562693233;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=LrcE6R2o26oEQGuoGYqTrta9SpkAQFdiIL/H77HUvqI=;
 b=rhhZcozINIpdVkf96sYQvh68ES+ra2FmvX/eU9RXEt+SSkhGYXAU+nMhYLIDYAmcdSF0fE
 8cqJTgPdwkyj4jiAS891ZTDpCYETCHLvOB4XgVeP7QQ2RVxrO7Iup4nIS3rewTCkAIef8b
 f/6JiXf5u/vzaO+Z+i7QWmLKL4OfYwc=
From: Sven Eckelmann <sven@narfation.org>
To: b.a.t.m.a.n@lists.open-mesh.org
Subject: [PATCH v3 5/6] batctl: Replace '-m meshif' option with selector prefix
Date: Tue,  9 Jul 2019 19:26:50 +0200
Message-Id: <20190709172651.5869-6-sven@narfation.org>
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=narfation.org; 
 ...
 in-reply-to:in-reply-to:references:references;
 bh=LrcE6R2o26oEQGuoGYqTrta9SpkAQFdiIL/H77HUvqI=;
 b=R1x6w9mxDKEz16Dsu6FfCQKyuk/vOvhS7UMoI7D472CW1s3zK4p17QJKRi2KefaxnSmWik
 JNyIzf32AltoFo3++OgxGXHCiXwug4X5FjcsVJUi98HF90moowpvY2uU3H+ab8Dg+zCqL1
 XLq2rc++nRz5GpSoW71AHM5RI0qboQg=
ARC-Seal: i=1; s=20121; d=narfation.org; t=1562693233; a=rsa-sha256; cv=none;
 b=f3hK1tWeU3tMZIXgA77I5Na35QVC3MiZUowrItFP6ppikFGnP8bFP/nu+nOxKy7zTefOBk
 PSVOu02tdCF2dTk4ejLfrFqWDJFsNO3cZe03DGOunsOabI9qAwVnBJALgedECdSgOaUdkn
 ThM3sTAbTzM9Jmh1CtMEXEjPt0FA5HE=
...
index 0a694c9..c2bfc74 100644
--- a/interface.c
+++ b/interface.c
@@ -541,5 +541,5 @@ static int interface(struct state *state, int argc, char **argv)
 	return EXIT_FAILURE;
 }

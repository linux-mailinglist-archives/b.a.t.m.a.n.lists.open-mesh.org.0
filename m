...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id YI2rL8IMDGqFUwUAu9opvQ
	(envelope-from <b.a.t.m.a.n-bounces+lists+b.a.t.m.a.n=lfdr.de@lists.open-mesh.org>)
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 19 May 2026 09:09:54 +0200
X-Original-To: lists+b.a.t.m.a.n@lfdr.de
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id 6746A578AEA
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 19 May 2026 09:09:54 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 3EFE180D1B
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 19 May 2026 09:09:54 +0200 (CEST)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1779174594;
 b=jxgH9d+E+xUDan0LcpcodGUWk5kdtzuYEtN9/AmWyz7Y+ymB9uTgvhiLpAMC3f1JpQ7CL
 ygBkXGpyDlEh4ahlyviPRxgXxCx65E3hQpIND20qP+3wmBbAaxm3X9CuZnOCZXm2CzPANgW
 v3f7DvCqc1THCGoQcl5QLfUy3gsSQJE=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1779174594; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=hNiEN6sSNC1g2jKLWoUEwvF/EhGQ+LkuTesq9U7Lko4=;
 b=RdsgH/+rkfC/+nK/YoZu50Pyw0SiPCLJ8hABfiuBw6SfYhcRUBVfAVY6xnCN4DppOdaK1
 Jno4zohRfQxUrkqG1E/l3EvS3O2JN3nSOGe/NnhwIWvNWnsIEmivPZONXWnFt8PUCpKXzY2
 7b5GB0/7XcBZyETCxtUDAJJbrYJgVpg=
...
Received: from dvalin.narfation.org (dvalin.narfation.org [213.160.73.56])
	by diktynna.open-mesh.org (Postfix) with UTF8SMTPS id 10B1380D6D
	for <b.a.t.m.a.n@lists.open-mesh.org>; Tue, 19 May 2026 09:04:45 +0200 (CEST)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1779174285;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=hNiEN6sSNC1g2jKLWoUEwvF/EhGQ+LkuTesq9U7Lko4=;
	b=A5gOhruyGIAoJZxBIaJQBeiwD3c4PbK9o4jCLjc+1NAqnfPiBFhbRcDQSIZpfHxMsgjOsx
	095bsY+CbisghEul5lBqFjA6r2HucNaFB+eAcSCEZeePitndrJjejCa736azXCGQa3uT0a
	AlZE20CGFc7ICsB2eM7EfiCd5raXRLU=
ARC-Seal: i=1; a=rsa-sha256; d=open-mesh.org; s=20121; cv=none; t=1779174285;
	b=Q4kSl+JpUO/U6CI+M+8oOuBBv4qKPslME8Vypojyt5wOU6LGMhdpdBQ4qpMDshbwz8gXjJ
	QbWxGeVVUK1RMX7m62a8vhLwJ5ABupRgrGEbdUCpEGlihXw3XnJD6Ne6mrEiJLvbRqQ2bi
	IBQqiS0f2ZEjzBZVYdqZSnJtKS6G4mc=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=narfation.org header.s=20121 header.b=2JaWw+2q;
	spf=pass (diktynna.open-mesh.org: domain of sven@narfation.org designates
 213.160.73.56 as permitted sender) smtp.mailfrom=sven@narfation.org;
	dmarc=pass (policy=none) header.from=narfation.org
Received: by dvalin.narfation.org (Postfix) id BA17A1FE24;
	Tue, 19 May 2026 07:04:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=narfation.org;
	s=20121; t=1779174284;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=hNiEN6sSNC1g2jKLWoUEwvF/EhGQ+LkuTesq9U7Lko4=;
	b=2JaWw+2qLgMp9IB5IrRdrXKJrvSM4jE/npqUa1Hfe0APB6iYeO/z38ieI9O4i+QfsEgngF
	+lL6tq/FDmkVBuPWWZXHJjlDqqBvEroErBVW7HvCPZrWccWWVQg1fuEiNI8lwtI7JfSJnZ
	xGT74L5llgL/SjwQ7ZG3T00Y0QD2Rf8=
From: Sven Eckelmann <sven@narfation.org>
Date: Tue, 19 May 2026 09:04:36 +0200
Subject: [PATCH batadv v2 1/7] batman-adv: replace non-atomic meshif config
 fields with (READ|WRITE)_ONCE
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260519-atomic-to-write-once-v2-1-1b643e847a56@narfation.org>
...
X-Mailer: b4 0.15.2
X-Developer-Signature: v=1; a=openpgp-sha256; l=36278; i=sven@narfation.org;
 h=from:subject:message-id; bh=mzJoYjdKP4Kpbg8ONnPwGkwQrfqeJjSm+XKIrh5pI0g=;
 b=owGbwMvMwCXmy1+ufVnk62nG02pJDFk83K3XzLbcXBf8NaerLfmohq/yn7vlZ99KvZ1+Y+7cP
 dnvVsU2dZSyMIhxMciKKbLsuZJ/fjP7W/nP0z4ehZnDygQyhIGLUwAmUl3EyHC051jToUaB543L
 j54Tadm6WK1gqtbRi5cnm/F8aHtx/fglRoY/F25YTVkVFyt7cNcdsy1Pmm/sulD/wmj6wrW71Te
 ocT1kBQA=
X-Developer-Key: i=sven@narfation.org; a=openpgp;
 fpr=522D7163831C73A635D12FE5EC371482956781AF
Message-ID-Hash: 3JSRSU7L2RORVD5HPEKEAUKSQERZOBQO
X-Message-ID-Hash: 3JSRSU7L2RORVD5HPEKEAUKSQERZOBQO
...
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/3JSRSU7L2RORVD5HPEKEAUKSQERZOBQO/>
List-Archive: 
...
index e3870492..9ab04a99 100644
...
+#include <linux/compiler.h>
 ...
 #include <linux/errno.h>
 #include <linux/etherdevice.h>
@@ -105,7 +106,7 @@ static void batadv_v_ogm_start_timer(struct batadv_priv *bat_priv)
...
@@ -239,7 +240,7 @@ static void batadv_v_ogm_queue_on_if(struct sk_buff *skb,
 {
...
@@ -474,7 +475,7 @@ static u32 batadv_v_forward_penalty(struct batadv_priv *bat_priv,
 				    u32 throughput)
 {
...
index 0a8bd95e..13b88121 100644
--- a/net/batman-adv/distributed-arp-table.c
+++ b/net/batman-adv/distributed-arp-table.c
@@ -742,7 +742,7 @@ static void batadv_dat_tvlv_container_update(struct batadv_priv *bat_priv)
 {
 	char dat_mode;
...
+	dat_mode = READ_ONCE(bat_priv->distributed_arp_table);
 	...
 	switch (dat_mode) {
 	case 0:
@@ -1138,7 +1138,7 @@ bool batadv_dat_snoop_outgoing_arp_request(struct batadv_priv *bat_priv,
 	int hdr_size = 0;
 	unsigned short vid;
...
@@ -1233,7 +1233,7 @@ bool batadv_dat_snoop_incoming_arp_request(struct batadv_priv *bat_priv,
 	unsigned short vid;
 	int err;
...
+	if (!READ_ONCE(bat_priv->distributed_arp_table))
 	...
 	vid = batadv_dat_get_vid(skb, &hdr_size);
@@ -1295,7 +1295,7 @@ void batadv_dat_snoop_outgoing_arp_reply(struct batadv_priv *bat_priv,
 	int hdr_size = 0;
 	unsigned short vid;
...
+	if (!READ_ONCE(bat_priv->distributed_arp_table))
 	...
 	vid = batadv_dat_get_vid(skb, &hdr_size);
@@ -1343,7 +1343,7 @@ bool batadv_dat_snoop_incoming_arp_reply(struct batadv_priv *bat_priv,
 	bool dropped = false;
 	unsigned short vid;
...
+	if (!READ_ONCE(bat_priv->distributed_arp_table))
 	...
 	vid = batadv_dat_get_vid(skb, &hdr_size);
@@ -1713,7 +1713,7 @@ void batadv_dat_snoop_outgoing_dhcp_ack(struct batadv_priv *bat_priv,
...
@@ -1743,7 +1743,7 @@ void batadv_dat_snoop_incoming_dhcp_ack(struct batadv_priv *bat_priv,
 	__be16 proto;
 	u8 *hw_src;
...
@@ -1788,7 +1788,7 @@ bool batadv_dat_drop_broadcast_packet(struct batadv_priv *bat_priv,
...
index a9d0346e..b163d6a8 100644
--- a/net/batman-adv/gateway_client.c
+++ b/net/batman-adv/gateway_client.c
@@ -170,7 +170,7 @@ void batadv_gw_check_client_stop(struct batadv_priv *bat_priv)
 {
...
@@ -702,7 +702,7 @@ bool batadv_gw_out_of_range(struct batadv_priv *bat_priv,
 	if (!gw_node)
 		goto out;
...
index d6732c34..2cd314ff 100644
--- a/net/batman-adv/hard-interface.c
+++ b/net/batman-adv/hard-interface.c
@@ -594,7 +594,7 @@ int batadv_hardif_min_mtu(struct net_device *mesh_iface)
 	}
 	rcu_read_unlock();
...
@@ -709,6 +709,7 @@ int batadv_hardif_enable_interface(struct batadv_hard_iface *hard_iface,
...
@@ -746,15 +747,14 @@ int batadv_hardif_enable_interface(struct batadv_hard_iface *hard_iface,
...
index c8c3e806..13c3052a 100644

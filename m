...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D03459C7023
	for <lists+b.a.t.m.a.n@lfdr.de>; Wed, 13 Nov 2024 14:04:05 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id A551A83FAC
	for <lists+b.a.t.m.a.n@lfdr.de>; Wed, 13 Nov 2024 14:04:05 +0100 (CET)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1731503045;
 b=dId3pZu2PKqukNDvaA7MiKrfwg2QFfAsgm0EYLB5KrROJw3BBUD6ROjRf6JfE2iGsXnKj
 4XundhoiH/TwY56S3esSOH50uah/xYHP6QFHYvfHleaBPKn9jXN1kRM20D1oOSa2I5tzxOv
 rftBUus7oMT1Ij9Z+UxjTGgKpbKDUy0=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1731503045; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=c4uHKNgHTelYlny2krcQ638zz7tT9VKe4QfYY382d0Q=;
 b=rPumk+Ey/4LTPCPi8Ddwl3x/5Vy1gQECfMCMVPJLUPT69aC4OnrtRXpT35bogA1iHx5Sz
 33ol9y7JkF7POaHa8wasPT+uLpezRxc07wRG3vAIoTUyZcmJZ3TBHRhYtkQuko5HE+o5PPM
 H7ArGZXLUD1olHm+Yo4l2BQjsX/fcC0=
...
Received: from mail-pg1-x52d.google.com (mail-pg1-x52d.google.com
 [IPv6:2607:f8b0:4864:20::52d])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 3F96F831EC
	for <b.a.t.m.a.n@lists.open-mesh.org>; Wed, 13 Nov 2024 13:58:12 +0100 (CET)
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1731502692; a=rsa-sha256;
	cv=none;
	b=bICYMEv/iEWH5Mxdia3PZuYVKdWm08iqbTern4gqWAouv2W2jbLqBlWR0egcAwc5Yig11m
	MLXH5abaTgkWr1vZ1DLGSe4EL6066AAkSJrKup4PGSQhyOssWZc43hBAeB6PoaNeXUWeTZ
	01qLdEA16EvZv72EQSVMLtgBXVUxGdE=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=gmail.com header.s=20230601 header.b=GaxCkmrM;
	dmarc=pass (policy=none) header.from=gmail.com;
	spf=pass (diktynna.open-mesh.org: domain of shaw.leon@gmail.com designates
 2607:f8b0:4864:20::52d as permitted sender) smtp.mailfrom=shaw.leon@gmail.com
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1731502692;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=c4uHKNgHTelYlny2krcQ638zz7tT9VKe4QfYY382d0Q=;
	b=dHY2MGYRz8jCNjPWRu+DdFghqmDBD+twPXxRu+FT9wdtbOyFQrxCFJKXvKkEx7Hw890O00
	5FRUMFdsM9OUEZF7CYvBNYCT8IPyRYiuRp0qVaLSE1myH5Y1tqjLgqcxn2RtwDx+QiMjLI
	G4Lv2ZZQijwufuuJamhadEALU4faH6Y=
Received: by mail-pg1-x52d.google.com with SMTP id
 41be03b00d2f7-7ed9c16f687so4687913a12.0
        for <b.a.t.m.a.n@lists.open-mesh.org>;
 Wed, 13 Nov 2024 04:58:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1731502691; x=1732107491;
 darn=lists.open-mesh.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=c4uHKNgHTelYlny2krcQ638zz7tT9VKe4QfYY382d0Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=c4uHKNgHTelYlny2krcQ638zz7tT9VKe4QfYY382d0Q=;
        b=
X-Forwarded-Encrypted: i=1;
 AJvYcCWFxFgNw2543FStpBTxqadVhKr6Zra+O3E70aQvAy6L/Gmqj7QIt9wTuohA9+7y8QquGQVDohoJQ1VCHA==@lists.open-mesh.org
X-Gm-Message-State: AOJu0YxHJFNcuXd+bKZh+F8y74foSR3LM4i5+WPqoHgaECtMYkH//uhq
	ji8aBIGZtB69EjbKkNx6WTZBfIV1X2AjvNhgV0HKyelutCeZVhwL
X-Google-Smtp-Source: 
 AGHT+IEW/8FLBI4yQo5ibxoGCxIofggmcjjVftErLiAf+Ryg0MG2XED6WhS+2Fn2LgKf4ZhExPXwEQ==
X-Received: by 2002:a05:6a20:244d:b0:1db:e0d7:675c with SMTP id
 adf61e73a8af0-1dc7037f641mr3401109637.13.1731502690293;
        Wed, 13 Nov 2024 04:58:10 -0800 (PST)
Received: from nova-ws.. ([103.167.140.11])
        by smtp.gmail.com with ESMTPSA id
 98e67ed59e1d1-2e9f3f8ed0esm1398632a91.40.2024.11.13.04.58.01
...
Subject: [PATCH net-next v3 4/6] rtnetlink: Decouple net namespaces in
 rtnl_newlink_create()
...
Message-ID-Hash: YFOHY57N7IW4IYLIEBXAB2HEG4KA5HAA
X-Message-ID-Hash: YFOHY57N7IW4IYLIEBXAB2HEG4KA5HAA
...
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/YFOHY57N7IW4IYLIEBXAB2HEG4KA5HAA/>
List-Archive: 

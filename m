...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 85E9B37A578
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 11 May 2021 13:09:22 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id A1FD383F1E;
	Tue, 11 May 2021 13:09:21 +0200 (CEST)
Received: from NAM10-MW2-obe.outbound.protection.outlook.com (mail-mw2nam10on20600.outbound.protection.outlook.com [IPv6:2a01:111:f400:7e89::600])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 0372680603
	for <b.a.t.m.a.n@lists.open-mesh.org>; Tue, 11 May 2021 11:30:36 +0200 (CEST)
...
X-MS-Exchange-AntiSpam-MessageData: 
	=?utf-8?B?WUdYUE0wQjVzVkFjMEdaZ1UrQmdEWlJqZWtvWGZteVduRG80U3EwVTl3VUZa?=
...
ARC-Seal: i=2; s=20121; d=open-mesh.org; t=1620725437; a=rsa-sha256;
	cv=pass;
	b=aVYscT5obL9JB24/TIHMmeKa/cTeLX+6oYt9R8n/0C4dLVSU/d1sqyyr61ubPEM9dWA5UV
	lLGIATe232EzDVsEOn8pQT83csg4B75WJgid7sBaJsx2atGMBt/bkCWuEm2RMn2T4t5z6E
	vr6jtdXLEf1F4DBkA63O1y91a4JOV6k=
ARC-Authentication-Results: i=2;
	diktynna.open-mesh.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=slXROiDI;
	arc=pass ("microsoft.com:s=arcselector9901:i=1");
	spf=softfail (diktynna.open-mesh.org: 2a01:111:f400:7e89::600 is neither permitted nor denied by domain of nikolay@nvidia.com) smtp.mailfrom=nikolay@nvidia.com
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1620725437;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=aocN83HuzwP32rnj53taPT09V0+IeF7AOLl2bmoJm7c=;
	b=jCsOySmLrUyDt1LH2/4B5owspTgZgXLOOQh3LG9ZH8cfICJoTqlGtqwG4KaQZ7OmJUzX67
	AjBRV6q/vWzwDGttth1e0/pVGPTGuuSL8gGFdoKm9fAHqk2TeJ5GasBE4HrxIjHIgRdQI4
	coPcy1uvTuhx72IkJJzKtfP01H9+zgI=
Content-Transfer-Encoding: quoted-printable
X-MailFrom: nikolay@nvidia.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-b.a.t.m.a.n.lists.open-mesh.org-0; header-match-b.a.t.m.a.n.lists.open-mesh.org-1
Message-ID-Hash: HFXY54IHBRDLE3W7BB77JB7LJH3SWT3D
X-Message-ID-Hash: HFXY54IHBRDLE3W7BB77JB7LJH3SWT3D
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/HFXY54IHBRDLE3W7BB77JB7LJH3SWT3D/>
...
> Now that we have split the multicast router state into two, one for IPv=
4
...
> @@ -79,7 +79,13 @@ static int br_rports_fill_info(struct sk_buff *skb, =

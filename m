...
Received: from mail.lfdr.de
	...
	id PN2YDRdJU2o/ZgMAu9opvQ
	(envelope-from <b.a.t.m.a.n-bounces+lists+b.a.t.m.a.n=lfdr.de@lists.open-mesh.org>)
	for <lists+b.a.t.m.a.n@lfdr.de>; Sun, 12 Jul 2026 09:58:15 +0200
X-Original-To: lists+b.a.t.m.a.n@lfdr.de
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id AC0567441AC
	for <lists+b.a.t.m.a.n@lfdr.de>; Sun, 12 Jul 2026 09:58:14 +0200 (CEST)
...
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 7AB6880F54
	for <lists+b.a.t.m.a.n@lfdr.de>; Sun, 12 Jul 2026 09:58:14 +0200 (CEST)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1783843094;
 b=1hX3syl9XZMLMMttA9URXCJ/gc9sHd/LM7SDnWG3ufBOZ5mBLMEJBmLaFy1igeAXHUVcL
 PNRHeROsVGZ8aFg3a8f8pq8d3mR0rSBa0kFMXXFCUKF+QO/IqfDe5xUHgCbYJ4VBUNCFuts
 OHbDnNej1gFFQ3XJB7N0vgaMdgZ3rQo=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1783843094; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=B0E18Jl6xBp+kRv42J1XPXUtUtuXMI5zrKDX66plXNU=;
 b=Hf1UXfVonc06hq4Eivy7Z8iH36fXS6qx+Wdu/TiseHGlbBRzQG2FTpKbRUSbQ0WLQX+iE
 2tzocszI+bifBGATMA54lk0JYJNRzjGgpcx4NAnhD8Aq/lVPHBn2u4QcARsaqp9qdfg6PF9
 oAIf2RNMQFSkrK+mZcSO+qHWKDkyC0M=
ARC-Authentication-Results: i=2; open-mesh.org;
 dkim=fail;
 arc=pass;
 dmarc=fail header.from=suse.de policy.dmarc=none
Received: from smtp-out2.suse.de (smtp-out2.suse.de
 [IPv6:2a07:de40:b251:101:10:150:64:2])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id B6D0F81215
	for <b.a.t.m.a.n@lists.open-mesh.org>; Sun, 12 Jul 2026 03:46:08 +0200 (CEST)
ARC-Seal: i=1; a=rsa-sha256; d=open-mesh.org; s=20121; cv=none; t=1783820768;
	b=rwGAW9g3nc3/y2pWPKuCxcRyjB+1Xxl5Yrxc9OZsl7QSGHeY+ho6a/cUJ3N3Gv9MKJa3C4
	rtIpjGiTe0u4+Drm6P1aIXLEGMVfkH5W2TuU6IGhgM6Ks40uMBJamfd336wxbOv8Cbi7N3
	OKsumXoq0ao6tsY73VOA+DIaQpQ96T0=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1783820768;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=B0E18Jl6xBp+kRv42J1XPXUtUtuXMI5zrKDX66plXNU=;
	b=iT72DdaJTCelHYG3J6hswcRRizVfDUDxJIPrEyRviwL7ysA9/0MC8QrMLGS/d4zVhBsnXK
	JWtC+4RfJB00EmESv6EXIgc1GjaovnkpmEZLUgyHhByGSjaWub5nUOaCsRx5ppDL/6Actx
	IL3yxnRjVYBZQ+7eiiOCPRclcmZ02+4=
...
Received: from imap1.dmz-prg2.suse.org (imap1.dmz-prg2.suse.org
 ...
 SHA256)
	...
	by smtp-out2.suse.de (Postfix) with ESMTPS id 43BED76D93;
...
Subject: [PATCH 01/13 RFC net-next] net: ipv4: introduce CONFIG_IPV4 to
...
Message-ID-Hash: 33XQDHCX3V5LHT4TGT5YHCUSB7GZOT66
X-Message-ID-Hash: 33XQDHCX3V5LHT4TGT5YHCUSB7GZOT66
X-Mailman-Approved-At: Sun, 12 Jul 2026 09:57:59 +0200
X-Mailman-Version: 3.3.10
Precedence: list
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/33XQDHCX3V5LHT4TGT5YHCUSB7GZOT66/>
List-Archive: 
...
X-Spamd-Result: default: False [1.79 / 15.00];
 ...
 @arndb.de,m:nb@tipi-net.de,m:florian.fainelli@broadcom.com,m:hkallweit1@gmail.com,m:krzk@kernel.org,m:rmk+kernel@armlinux.org.uk,m:me@ziyao.cc,m:siyanteng@cqsoftware.com.cn,m:maxime.chevallier@bootlin.com,m:julianbraha@gmail.com,m:a0987203069@gmail.com,m:weishangjuan@eswincomputing.com,m:wens@kernel.org,m:inochiama@gmail.com,s:lists@lfdr.de];
	...
	ALIAS_RESOLVED(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[suse.de:from_mime,suse.de:email,suse.de:mid,diktynna.open-mesh.org:helo,diktynna.open-mesh.org:rdns];

...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FB7CA2EE6D
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 10 Feb 2025 14:38:22 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 29D2084285
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 10 Feb 2025 14:38:22 +0100 (CET)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1739194702;
 b=bOgdpFqLL3NMVjjVGHq+UtvJiqGvU1sYSmXJWkan5laqS27f/adf4Gzt8fXjJca4chyns
 3yVZ9WGq3yE5GhLcgUgOKJ8rPN5g0BXiQDaSNXMjiNs/QZJ417uk44eSLcthhNd6XCUmdw6
 0H6QPIhZY5UzZYjQcsJNrxDKzRF+KBY=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1739194702; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=133k00XYUKhM1CLkQRscpJPFuQqBgZ8D5itO6oI4RDY=;
 b=2QFaYx1QBIiVVpUKTmAefO9/4zVHV8IUans0ikpp+/GCWVExsToHujQAremtjNF3SzeSL
 wsTs+Ccqif7iQbrB29hr5hoUPxQyPZPQfhob6uWCo/wK79VD6Z9BWgrvATHuQICICRJENBG
 n9qKcd40TUUWHrzO8Ab6IZjWbaY/Yqg=
...
Received: from mail-pl1-x631.google.com (mail-pl1-x631.google.com
 [IPv6:2607:f8b0:4864:20::631])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id A5A3183E3C
	for <b.a.t.m.a.n@lists.open-mesh.org>; Mon, 10 Feb 2025 14:30:37 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1739194237;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=133k00XYUKhM1CLkQRscpJPFuQqBgZ8D5itO6oI4RDY=;
	b=LjcJdgrUkkC1BOYvBfw7BlBcn8WbLX++QrL52+xaePeNCCMKqrhOZgpwO6mQRXR9ejY2I2
	q54qdziNwYlYF1OomRuJ5w1m/6VwNuYj4Qpt14tkh9ih9WOHqmsmITyDk+4KPLpKvT5XYz
	wx12nbwRC9MZu+5jGc9TV5+ttwz8vR8=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=gmail.com header.s=20230601 header.b=SgzL1Dro;
	spf=pass (diktynna.open-mesh.org: domain of shaw.leon@gmail.com designates
 2607:f8b0:4864:20::631 as permitted sender)
 smtp.mailfrom=shaw.leon@gmail.com;
	dmarc=pass (policy=none) header.from=gmail.com
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1739194237; a=rsa-sha256;
	cv=none;
	b=ovI91rUg0WSZWLdzl1xZ/s9e2pAnpxoEdd50QoKwoRQbokxLsGOhqMXARjRZTrlEr/5d86
	ltRNpe3INQzPI4bFyiCLlIeW08G3qN5vjYKj5Q0kkN2b1+GYZie5sSK6UiPQvF0KTiNp8n
	t71C+CuC8L5VbLEkeLCO5Q7eDePkMzY=
Received: by mail-pl1-x631.google.com with SMTP id
 d9443c01a7336-21f92258aa6so26130325ad.3
        for <b.a.t.m.a.n@lists.open-mesh.org>;
 Mon, 10 Feb 2025 05:30:37 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1739194236; x=1739799036;
 darn=lists.open-mesh.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=133k00XYUKhM1CLkQRscpJPFuQqBgZ8D5itO6oI4RDY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=133k00XYUKhM1CLkQRscpJPFuQqBgZ8D5itO6oI4RDY=;
        b=
X-Forwarded-Encrypted: i=1;
 AJvYcCUqwcwab0ufN0vBxY/qbWIrzYVz3+vhXhHuvbagi6WHqNIan63qs0PSQWIIELBSs97x0ml97c31r+KP9w==@lists.open-mesh.org
X-Gm-Message-State: AOJu0Yx3YfzWTQ7n9bfa6eUZ6i+YY0StItrdOlzEGELjQW8Zhzmt0Myx
	MUhKujPOBPUH+qWZJICN8TsxuLXrSFJXnUdcGgMotnwZy8vmbMo1
X-Gm-Gg: 
X-Google-Smtp-Source: 
 AGHT+IGZMCndp/MixtUvyKhByg256N21W7U/+hussdNhUnKsXad18PdQznyf9kw8PP/bNXWSLtDkaA==
X-Received: by 2002:a17:902:e802:b0:219:d28a:ca23 with SMTP id
 d9443c01a7336-21f4e75e4damr224697595ad.36.1739194235628;
        Mon, 10 Feb 2025 05:30:35 -0800 (PST)
Received: from ws.. ([103.167.140.11])
        by smtp.gmail.com with ESMTPSA id
 d9443c01a7336-21f3653af3bsm78799445ad.57.2025.02.10.05.30.26
...
Subject: [PATCH net-next v9 02/11] rtnetlink: Pack newlink() params into
 struct
...
Message-ID-Hash: OLYHMCIYSZ2IKNMJOXIHTBU6MWQIMNEH
X-Message-ID-Hash: OLYHMCIYSZ2IKNMJOXIHTBU6MWQIMNEH
...
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/OLYHMCIYSZ2IKNMJOXIHTBU6MWQIMNEH/>
List-Archive: 

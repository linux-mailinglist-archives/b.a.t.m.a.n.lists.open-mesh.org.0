...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id KKq8EZ5SGGqwiwgAu9opvQ
	(envelope-from <b.a.t.m.a.n-bounces+lists+b.a.t.m.a.n=lfdr.de@lists.open-mesh.org>)
	for <lists+b.a.t.m.a.n@lfdr.de>; Thu, 28 May 2026 16:35:10 +0200
X-Original-To: lists+b.a.t.m.a.n@lfdr.de
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id 02E165F3C30
	for <lists+b.a.t.m.a.n@lfdr.de>; Thu, 28 May 2026 16:35:09 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id B4091841DC
	for <lists+b.a.t.m.a.n@lfdr.de>; Thu, 28 May 2026 16:35:09 +0200 (CEST)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1779978909;
 b=k9UMcJNNP5SprOZpg7mX/GvRDiOEHTmR35ruXq1PkPK2xDzb4M/frHNtnKkEsi9xbYDia
 5lj85xxOlEI5rE2vGpSASEP90kvu/W+CheNOPIS0L9B+SzDvDzfswR1QoGUq0pYoiUeZX6S
 8KyiccizNcqvjbbLgKAPE9THrRM7HBA=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1779978909; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=tuu4gdCb+WOeG2bFs3z9oMkWXWWHtfKHdjcRZP1ruBc=;
 b=vC+HLNVG80k39QWP2i6z54RTU8oyyienrLdFsoZFwFDYnYhrEgAqEA8eNYCNpS1/vIM2H
 vPBa8inbH0w/h3zRPzibHsJbUah3ouOcPOuO7UWYtZWBm4vhBcFcTYoyepNrQsaeiAFOHKw
 02O5crkmYCka4kJggTwwaV9OXLDW8oI=
...
Received: from mail.simonwunderlich.de (mail.simonwunderlich.de
 [IPv6:2a01:4f8:c17:e8c0::1])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 5375983D53
	for <b.a.t.m.a.n@lists.open-mesh.org>; Thu, 28 May 2026 16:29:32 +0200 (CEST)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1779978572;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=tuu4gdCb+WOeG2bFs3z9oMkWXWWHtfKHdjcRZP1ruBc=;
	b=bLIIufYSVtSSQ4eQr6cocDl1m1gu8CtLA0wQ504eOPVpNJwvG1gNzyrV5CYVV05muaCTSB
	+Q/LJIBbtfXmra1ZnQuVPx7x54WiHHumWdkpW1fxjHP7UnmHdZ6Dsg7dR/VEC7f3WDyrw2
	i8Lqnl6dqbHEcAUVp8eZ0Q/F1o21QWg=
ARC-Seal: i=1; a=rsa-sha256; d=open-mesh.org; s=20121; cv=none; t=1779978572;
	b=FK7cl4smwmefBm1q7fcqO3NiAajzXB78vJn7NJqnOHe1+QJz3eZ7gjYP2bf+IKoFxyeK46
	u4phBRJmEPkqEFkZHe45WcFkyiGQYS/l/0ElBmLQXeUqh55rEzypaXYPLxz2i4wLU3qNuh
	wtWN9UgEyES2G2OQO+oYh0r1/BfAL+s=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=simonwunderlich.de header.s=09092022 header.b=VE0onoMK;
	spf=pass (diktynna.open-mesh.org: domain of sw@simonwunderlich.de designates
 2a01:4f8:c17:e8c0::1 as permitted sender)
 smtp.mailfrom=sw@simonwunderlich.de;
	dmarc=pass (policy=none) header.from=simonwunderlich.de
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=simonwunderlich.de;
	s=09092022; t=1779978571;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=tuu4gdCb+WOeG2bFs3z9oMkWXWWHtfKHdjcRZP1ruBc=;
	b=
...
Date: Thu, 28 May 2026 16:29:16 +0200
Message-ID: <20260528142924.329658-8-sw@simonwunderlich.de>
...
Message-ID-Hash: CO354EG2TIZQNNZ65FS4DIWJA42ZJOXQ
X-Message-ID-Hash: CO354EG2TIZQNNZ65FS4DIWJA42ZJOXQ
...
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/CO354EG2TIZQNNZ65FS4DIWJA42ZJOXQ/>
List-Archive: 

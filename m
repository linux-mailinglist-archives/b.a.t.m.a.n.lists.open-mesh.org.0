...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id ED7C29E9C18
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon,  9 Dec 2024 17:50:17 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id A6C7183FC2
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon,  9 Dec 2024 17:50:17 +0100 (CET)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1733763017;
 b=eHuAy/6MSn4p/u60q1g0ShClzNGdk+7dJrlazFKY9hU5W7aYCK8mPvjhoo6RD5rT1pjRB
 d2OEaI4PCbq3EE5Faf+2A/8FRp39O7vO0nNH8LM72Pe/SxIgMtZgPbrXrQMoo+MgwfxBCSb
 swoqxP+p9Ro/T9FCGSK/pLDsnJGLx00=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1733763017; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=qPy/Wa4sfWIv6r2JdpWfPhpUlAIM+rgHQUPWOAmdvfo=;
 b=Zvj1Z2rtA3YiNzZPUJU84WeR3/DZBFbwdQ99LDL6Ec6sNFgkLjHw+0xDmCPY68pB42mB1
 dI7+/WVwVlyd6CDSAPXlPC2mBrE28S6iumTdVZn3Oe20B4yvuEgrDZ+9R+WPlmhUeIn+swc
 SNSNIkGyNO+aiIsqrGDT4AhKx+vwswo=
...
Received: from mail-pl1-x62a.google.com (mail-pl1-x62a.google.com
 [IPv6:2607:f8b0:4864:20::62a])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 125B183B82
	for <b.a.t.m.a.n@lists.open-mesh.org>; Mon,  9 Dec 2024 15:05:58 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1733753159;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=qPy/Wa4sfWIv6r2JdpWfPhpUlAIM+rgHQUPWOAmdvfo=;
	b=lHZeJHmnFSByYgL3IZ5NoYoyvjLmSyN1O1RIcYPw9gCCurb5UguZc04S/FGAycAikA2iGm
	jSI8MtlziqEWHYnDhQc7ujNXZwU0o9x/Jicn276VXxA6KdisfFfESIm9sas2Ij01gWBvQd
	VKuNS0PxRM1Jl1YIx88Ar4QMMUAxIaE=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1733753159; a=rsa-sha256;
	cv=none;
	b=ls9mhzpwIom1wtFrWjtI8bGJZKEs0WVuela47LwJvOsxb7DUEBOZUA46xOLHfhMaq6eONS
	b8VD3VEkORMyCN2u9aJWKJhQ1pSnCPzdVm9J1bllFZRKAxIhttIzyGo4uTRcM4N0RPfUo4
	LYMDgd0EzsW2f3hlsNkbNjSHGCVDWYI=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=gmail.com header.s=20230601 header.b=BvS8IZa5;
	spf=pass (diktynna.open-mesh.org: domain of shaw.leon@gmail.com designates
 2607:f8b0:4864:20::62a as permitted sender)
 smtp.mailfrom=shaw.leon@gmail.com;
	dmarc=pass (policy=none) header.from=gmail.com
Received: by mail-pl1-x62a.google.com with SMTP id
 d9443c01a7336-2162c0f6a39so15519335ad.0
        for <b.a.t.m.a.n@lists.open-mesh.org>;
 Mon, 09 Dec 2024 06:05:58 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1733753157; x=1734357957;
 darn=lists.open-mesh.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=qPy/Wa4sfWIv6r2JdpWfPhpUlAIM+rgHQUPWOAmdvfo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=qPy/Wa4sfWIv6r2JdpWfPhpUlAIM+rgHQUPWOAmdvfo=;
        b=
X-Forwarded-Encrypted: i=1;
 AJvYcCVcyf61HPcrwUBMzfJdb/SwfK/H/C5Ve+HRlprDGH+pnwsCPkjsJO46kZ3A11ZrgjaFvJQL9jO24iRoCQ==@lists.open-mesh.org
X-Gm-Message-State: AOJu0Yxg0ApCqNhCQdZ3DBOpbRmw205+QSu/Iyqaje+KAtuxCHk+NwIC
	fYom4o+XimUmme9WZpg3JApPz+uWh4UyeMMEUnyK07hAYIOoMBYy
X-Gm-Gg: 
X-Google-Smtp-Source: 
 AGHT+IFhtw6aOaRBRqvTJbYhi/Fe6yXPqzisSZXdysCa+uK3mB+MiqtBQc7Dx64qWN61pTDIg+VOTg==
X-Received: by 2002:a17:902:ce03:b0:212:1abb:cba1 with SMTP id
 d9443c01a7336-21611b1362emr181353375ad.24.1733753156954;
        Mon, 09 Dec 2024 06:05:56 -0800 (PST)
Received: from nova-ws.. ([103.167.140.11])
        by smtp.gmail.com with ESMTPSA id
 d9443c01a7336-216221db645sm49605645ad.46.2024.12.09.06.05.46
...
Subject: [PATCH net-next v5 3/5] rtnetlink: Decouple net namespaces in
 rtnl_newlink_create()
...
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/ONIY4M4Y65ODRRV6VDZ3RIMG27TCQBZD/>
List-Archive: 

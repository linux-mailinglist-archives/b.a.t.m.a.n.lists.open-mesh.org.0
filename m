...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 165F024979C
	for <lists+b.a.t.m.a.n@lfdr.de>; Wed, 19 Aug 2020 09:43:10 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id CE35C80C47;
	Wed, 19 Aug 2020 09:43:08 +0200 (CEST)
Received: from EUR05-AM6-obe.outbound.protection.outlook.com (mail-am6eur05on20623.outbound.protection.outlook.com [IPv6:2a01:111:f400:7e1b::623])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id C07BF8012C
	for <b.a.t.m.a.n@lists.open-mesh.org>; Wed, 19 Aug 2020 09:39:55 +0200 (CEST)
...
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1597822796;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature:autocrypt:autocrypt;
	bh=W6x3GgEpno7AvdrV+HK4eH39Q6gZGOgil880CBOlwIk=;
	b=ySjLNW9i8YdiWXtlyacbWtt0r8DWM+PT4SxWPH2nmXsS8Zl/IjtGqxb7pePWi2MG1v6N3/
	e+HIQuie273+kwAcgOD7bu1l6vgtqXQ7fBX6P1f8dgChoFFep/GBXjfy4/6uS5t7JKfipy
	lt4bs2v8tVVnce1TgMIJp42db7XFY7w=
ARC-Seal: i=2; s=20121; d=open-mesh.org; t=1597822796; a=rsa-sha256;
	cv=pass;
	b=1ivikXVbh3re92fB3QUM1+lXYfxFMqEwzkG+jdH3GCNYz3oiEhuVphBFjXlRcsw9rt1g2G
	FXWQZaWRvQKyN6dfNN07nBDD1uXwfgKfXCi0lzE7vITiQRCMbOpo5owEQKjPq1ktpLk2qg
	jlhkE1Ms0651NG9AOKCmEL79BzO2uJg=
ARC-Authentication-Results: i=2;
	diktynna.open-mesh.org;
	dkim=pass header.d=haltian.onmicrosoft.com header.s=selector2-haltian-onmicrosoft-com header.b=E1hOWQgT;
	spf=neutral (diktynna.open-mesh.org: 2a01:111:f400:7e1b::623 is neither permitted nor denied by domain of jussi.kivilinna@haltian.com) smtp.mailfrom=jussi.kivilinna@haltian.com;
	arc=pass (microsoft.com:s=arcselector9901:i=1)
X-MailFrom: jussi.kivilinna@haltian.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-b.a.t.m.a.n.lists.open-mesh.org-0; header-match-b.a.t.m.a.n.lists.open-mesh.org-1
Message-ID-Hash: 2S6XSTNLPI5EUGX52G4SNI44FZZS6SQY
X-Message-ID-Hash: 2S6XSTNLPI5EUGX52G4SNI44FZZS6SQY
X-Mailman-Approved-At: Wed, 19 Aug 2020 07:43:06 +0200
X-Mailman-Version: 3.2.1
Precedence: list
Reply-To: The list for a Better Approach To Mobile Ad-hoc Networking <b.a.t.m.a.n@lists.open-mesh.org>
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/2S6XSTNLPI5EUGX52G4SNI44FZZS6SQY/>

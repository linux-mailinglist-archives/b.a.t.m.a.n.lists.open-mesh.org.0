...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 3143A2CF14A
	for <lists+b.a.t.m.a.n@lfdr.de>; Fri,  4 Dec 2020 16:55:46 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 735838264B;
	Fri,  4 Dec 2020 16:55:38 +0100 (CET)
Received: from simonwunderlich.de (simonwunderlich.de [79.140.42.25])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id F2CEF80D64
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	...
	bh=gsVMta9bz3kUJa8/5WZU0kHoUNx55WfN9mH6UmeXgIk=;
	b=gVdJR1wH+mR97a0C6NhXEW6nLZ50rBKcIFpdM11DDU9MW/Fhi7zdcEVo12PG2pYgndsfcv
	vIGapLGx42BpS72g80TvfrDpM/Oeq6Ytu850QKdHwIi82n8hH1dF0RJ/jo58uCcmGsWG44
	ao1zmwhLyDGCGjeHJUAZjx+w2nDbSxA=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1607097308; a=rsa-sha256;
	cv=none;
	b=X2I/ZkNSl2Ug2leZJa5P0fmBFP0Pr5DCAueuBh8o/qgJK2glcsXwHqRfq0QIfShTNEXx12
	tCxWLUDYTVFQESRg5i2RmmiDOXjmL7ahulGHKDTu+wodR0giJ7hxmKf6qnBN4M8Zm24AW5
	bg3Eleul17crEk6+s1gtLVo13vNpuM8=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=none;
	spf=pass (diktynna.open-mesh.org: domain of sw@simonwunderlich.de designates 79.140.42.25 as permitted sender) smtp.mailfrom=sw@simonwunderlich.de
Content-Transfer-Encoding: quoted-printable
Message-ID-Hash: FHBFUZIWL65YWJJJ6C23AGSHO2QMSRTG
X-Message-ID-Hash: FHBFUZIWL65YWJJJ6C23AGSHO2QMSRTG
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/FHBFUZIWL65YWJJJ6C23AGSHO2QMSRTG/>
...
@@ -116,29 +115,6 @@ int batadv_algo_select(struct batadv_priv *bat_priv,=
 const char *name)
 	return 0;
 }
=20
...
-#include "debugfs.h"
 ...
 #include "gateway_client.h"
 #include "log.h"
@@ -919,8 +918,6 @@ batadv_hardif_add_interface(struct net_device *net_de=
v)
...
=20
@@ -963,7 +960,6 @@ static void batadv_hardif_remove_interface(struct bat=
...
=20
@@ -984,9 +980,6 @@ static int batadv_hard_if_event_softif(unsigned long =
event,
...
=20
 	return NOTIFY_DONE;
@@ -1051,9 +1044,6 @@ static int batadv_hard_if_event(struct notifier_blo=
ck *this,
...
-
  ...
  * @bat_priv: the bat priv with all the soft interface information
@@ -232,11 +28,6 @@ int batadv_debug_log(struct batadv_priv *bat_priv, co=
nst char *fmt, ...)
 	vaf.fmt =3D fmt;
 	vaf.va =3D &args;
=20
...
-#include "debugfs.h"
 ...
 #include "gateway_client.h"
 #include "hard-interface.h"
@@ -823,18 +822,12 @@ static int batadv_softif_init_late(struct net_devic=
e *dev)

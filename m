...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 88005A3C3FF
	for <lists+b.a.t.m.a.n@lfdr.de>; Wed, 19 Feb 2025 16:45:06 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 65E4D841DA
	for <lists+b.a.t.m.a.n@lfdr.de>; Wed, 19 Feb 2025 16:45:06 +0100 (CET)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1739979906;
 b=3KPGHk+UzkRNCsFj3XyfVuh05KtD0sWzvvaPm53AZ7bljM4i6E2Lr6bgssYJQxH53XTOC
 LMoiGxVTvz0OLmo61Jf+pnNgrpjbiywvBD+1ApqRgpMuwd3fLkEM6p6GSvkoRCCdKQTyX6t
 1ANQE7ZugA6Y+lHPFs8BDujWOwblUeM=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1739979906; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=93fOiXLiPOPHhDRJ9eVLB7ZJAOD1HkX3lWv5xa2feOw=;
 b=YD/y2qg36saxflxc/2Ncm0i5/e2jywZtZxGtTOv3Ldk7XZaYgppx3EYyS4LFQrbgJiz4C
 mnMTEmJchQz+cAvx2/sOr1F3owGSrYPOo98WqgXTfclhJbbsfL2u37lazlADjb6Q4GN3r6z
 wwY1aa7qbuyK+y+kRFRMusW5d1EcirM=
...
Received: from mail-pl1-x62b.google.com (mail-pl1-x62b.google.com
 [IPv6:2607:f8b0:4864:20::62b])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 3938982D5E
	for <b.a.t.m.a.n@lists.open-mesh.org>; Wed, 19 Feb 2025 13:51:14 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1739969474;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=93fOiXLiPOPHhDRJ9eVLB7ZJAOD1HkX3lWv5xa2feOw=;
	b=SsBUDrpBlg7U2LwUyvCnM/x5IOfOI6YZBM/dQrFFR1REPSEqXI82EEHBuPDCMPHCoyUocu
	bEEwM4V5nTYyIiIT47+SO2Tql4e+ZnjYmB6AkoN4RqsbK3Iun2c5goyEzHUf1sqNSIHCCx
	deLj8HgO2KIY0NsF0f4y6pm2MZc9q14=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1739969474; a=rsa-sha256;
	cv=none;
	b=VeDfypbMmq02hoNf6kRYgiLmxiKMn70X4HaRjlFeuXoEqOkGjJo/L1TOX+iwgyHUEE7bMe
	wlhtI2jNXwUTBp79ZgNxbytlWmoLg7Kn8tj5V5Ae5IJqG1stJwZzVcK7c5IR8rcVFYYDbL
	tJdsrqSZ715vCv9brQlvjiBWPdFYPl4=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=gmail.com header.s=20230601 header.b=P4QcydCX;
	spf=pass (diktynna.open-mesh.org: domain of shaw.leon@gmail.com designates
 2607:f8b0:4864:20::62b as permitted sender)
 smtp.mailfrom=shaw.leon@gmail.com;
	dmarc=pass (policy=none) header.from=gmail.com
Received: by mail-pl1-x62b.google.com with SMTP id
 d9443c01a7336-21c2f1b610dso169825545ad.0
        for <b.a.t.m.a.n@lists.open-mesh.org>;
 Wed, 19 Feb 2025 04:51:14 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1739969473; x=1740574273;
 darn=lists.open-mesh.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=93fOiXLiPOPHhDRJ9eVLB7ZJAOD1HkX3lWv5xa2feOw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=93fOiXLiPOPHhDRJ9eVLB7ZJAOD1HkX3lWv5xa2feOw=;
        b=
X-Forwarded-Encrypted: i=1;
 AJvYcCXU9GuE2/D8sCqvyMWWX0yX6bk36qJYCDB+UgvM83eipo9LPccaU0D3fCu5fsB1ywQlg/RJHYTL7O2ejg==@lists.open-mesh.org
X-Gm-Message-State: AOJu0YwgNJjalRSbplfpNk6fQ1SG4J/6AI2C1+2wZPFTq92XXEdvny23
	pMDhx+FeeBshLc2fTy96NDX7juZ0wKBBh4Cs1KALo7k5VtSLcfuO
X-Gm-Gg: 
X-Google-Smtp-Source: 
 AGHT+IFwrijUxTicBZSeJZUUaytXHE0DfRRF5DwivmwpPm4+n8c4+GP1YGLfqkZTKfGUAWsG4vSnVg==
X-Received: by 2002:a17:902:ce03:b0:21f:6c81:f63 with SMTP id
 d9443c01a7336-22104020041mr311521055ad.16.1739969472430;
        Wed, 19 Feb 2025 04:51:12 -0800 (PST)
Received: from ws.. ([103.167.140.11])
        by smtp.gmail.com with ESMTPSA id
 d9443c01a7336-220d536436fsm103427175ad.64.2025.02.19.04.51.03
...
Subject: [PATCH net-next v10 02/13] rtnetlink: Pack newlink() params into
 struct
...
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/3UDI3AMTOOBMFKQ34HNQLEYXH5UPUN6X/>
List-Archive: 

...
Received: from mail.lfdr.de
	by lfdr with LMTP
	id +LRBG3sRHWrLVQkAu9opvQ
	(envelope-from <b.a.t.m.a.n-bounces+lists+b.a.t.m.a.n=lfdr.de@lists.open-mesh.org>)
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 01 Jun 2026 06:58:35 +0200
X-Original-To: lists+b.a.t.m.a.n@lfdr.de
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id 140C2619895
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 01 Jun 2026 06:58:34 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 50500806F7
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 01 Jun 2026 06:58:34 +0200 (CEST)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1780289914;
 b=YAf3+JL2/qXggZwVP2SXDeypcJJCCAS8srnJgnU60vZSjxQfytGoc28mNUTF+oZpb3wzt
 NB+J0eQT1vSq6AKHvoh8HT8AwWKRraafIaf8bn8JZHEFGVOSlvJvqkRzcj6vwS7NoS56y1c
 WNV20+mQMr4dA3lZdhQTh9FwsMR4O+Y=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1780289914; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=WuwAh6tRn4kxJtZAf7HLLiB7jKFYJ/GpLmk7gPLm8As=;
 b=gY02kuBqj/8PIKnKi1HP3R/WTggnlKleL9UvknxxDgyDGWitGgr2V+jOb8wsbOIznZ/pu
 TMMwvoEFZSAzDRXKoytmqUO64+i6QQ9naqRb3wTlJ+eJtundMfJi7ruKBLoB0im3LRU3Bx3
 oSb0vItiMlSOQ/lHZWcbmr4DsVu44Fc=
...
Received: from dvalin.narfation.org (dvalin.narfation.org
 [IPv6:2a00:17d8:100::8b1])
	by diktynna.open-mesh.org (Postfix) with UTF8SMTPS id 77FD282E04
	for <b.a.t.m.a.n@lists.open-mesh.org>; Mon, 01 Jun 2026 06:54:35 +0200 (CEST)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1780289675;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=WuwAh6tRn4kxJtZAf7HLLiB7jKFYJ/GpLmk7gPLm8As=;
	b=Nkhmp4UUCCGVBdKqDvyivuVtRWJqH9CSyNH1V33Yehf4+RDyQbk0jDayQOvUlaglTOa2ew
	VY0EpqwX0JA3izl/C5p2qHAoR3wHK79cupVU1k0NC5z3K0nC4WtOcuJBhVxni/EuiXd8vp
	YTBrtZxFwu4XJoA8Bp0FiMD5pmGiogo=
ARC-Seal: i=1; a=rsa-sha256; d=open-mesh.org; s=20121; cv=none; t=1780289675;
	b=khVRMbUxnoFDFglnmD8OtFEnfKQ7JGwubT+xpJLDuCX8OzQBvEchNIZBYesnt/SK9B3MEn
	LSQEpS0ISC2W6kHLtUNLj0DdPCs6xL3ukMean3S+lVbuJ3tB0sUTqUCRlY0hKuR4fo9sDj
	nHNdGmqpZVh9jEkVwC15TyGgWK3QjZ4=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=narfation.org header.s=20121 header.b=REwx1vN3;
	spf=pass (diktynna.open-mesh.org: domain of sven@narfation.org designates
 2a00:17d8:100::8b1 as permitted sender) smtp.mailfrom=sven@narfation.org;
	dmarc=pass (policy=none) header.from=narfation.org
Received: by dvalin.narfation.org (Postfix) id 635D11FEED;
	Mon, 01 Jun 2026 04:54:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=narfation.org;
	s=20121; t=1780289674;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=WuwAh6tRn4kxJtZAf7HLLiB7jKFYJ/GpLmk7gPLm8As=;
	b=REwx1vN3ae30qoKbYqOLto5OLZMm+3X4e5qfFlrHtDHhyUd8FKBLg3Dx/j08rQNZCg/DsP
	ZCl4niPD3gmePRzfQWe4eJlrmwLiiAST+sI7UJnLT9G0F0Roqvra+0xE3U1wimfLFp17cq
	PbC2G5zsBM6sBxvar5jTOD2ksufE2Ek=
From: Sven Eckelmann <sven@narfation.org>
Date: Mon, 01 Jun 2026 06:54:19 +0200
Subject: [PATCH batadv v5 5/7] batman-adv: tp_meter: split vars into sender
 and receiver types
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20260601-tp-reason-missing-v5-5-78a5b8fe6e67@narfation.org>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=41364; i=sven@narfation.org;
 h=from:subject:message-id; bh=R5MI4aBvk3gveKcs4JRKMGenaKTsiakyis1OPHlb1Hk=;
 b=owGbwMvMwCXmy1+ufVnk62nG02pJDFmyAtUVOrzHl8WYnUg8GTJtzWZH7fnJXVbXS+IuFk8Rb
 1SNi1zcUcrCIMbFICumyLLnSv75zexv5T9P+3gUZg4rE8gQBi5OAZhIXCsjwzvuhxfiA3YHlC/J
 X7v2Kp/kve531V+LXmkuF1FJn1YhcZzhv7Nk8l6PnD6VrVsO39j29MvZnJM7b1X/Yr0688GXz91
 lMqwA
X-Developer-Key: i=sven@narfation.org; a=openpgp;
 fpr=522D7163831C73A635D12FE5EC371482956781AF
Message-ID-Hash: AEDZ2YPRFBD2M6YIPEC5USULW3CHWSLE
X-Message-ID-Hash: AEDZ2YPRFBD2M6YIPEC5USULW3CHWSLE
...
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/AEDZ2YPRFBD2M6YIPEC5USULW3CHWSLE/>
List-Archive: 
...
index 195821b2..6e1fafba 100644
...
@@ -1077,25 +1069,25 @@ void batadv_tp_start(struct batadv_priv *bat_priv, const u8 *dst,
...
@@ -1115,7 +1107,7 @@ void batadv_tp_start(struct batadv_priv *bat_priv, const u8 *dst,
...
@@ -1137,7 +1129,7 @@ void batadv_tp_stop(struct batadv_priv *bat_priv, const u8 *dst,
 	if (!orig_node)
 		return;
...
@@ -1145,20 +1137,75 @@ void batadv_tp_stop(struct batadv_priv *bat_priv, const u8 *dst,
 	}
...
@@ -1169,11 +1216,11 @@ static void batadv_tp_reset_receiver_timer(struct batadv_tp_vars *tp_vars)
  */
...
@@ -1185,22 +1232,23 @@ static void batadv_tp_receiver_shutdown(struct timer_list *t)
...
+	batadv_tp_receiver_put(tp_vars);
 ...
 /**
@@ -1284,7 +1332,7 @@ static int batadv_tp_send_ack(struct batadv_priv *bat_priv, const u8 *dst,
  *
...
+static bool batadv_tp_handle_out_of_order(struct batadv_tp_receiver *tp_vars,
 ...
 {
 	const struct batadv_icmp_tp_packet *icmp;
@@ -1302,10 +1350,10 @@ static bool batadv_tp_handle_out_of_order(struct batadv_tp_vars *tp_vars,
...
@@ -1316,7 +1364,7 @@ static bool batadv_tp_handle_out_of_order(struct batadv_tp_vars *tp_vars,
...
+	list_for_each_entry_reverse(un, &tp_vars->common.unacked_list, list) {
 		...
 		if (new->seqno == un->seqno) {
 			if (new->len > un->len)
@@ -1341,10 +1389,10 @@ static bool batadv_tp_handle_out_of_order(struct batadv_tp_vars *tp_vars,
...
@@ -1354,7 +1402,7 @@ static bool batadv_tp_handle_out_of_order(struct batadv_tp_vars *tp_vars,
  *  without gaps
  * @tp_vars: the private data of the current TP meter session
  */
...
+static void batadv_tp_ack_unordered(struct batadv_tp_receiver *tp_vars)
 {
 	struct batadv_tp_unacked *un, *safe;
 	u32 to_ack;
@@ -1362,8 +1410,8 @@ static void batadv_tp_ack_unordered(struct batadv_tp_vars *tp_vars)
...
@@ -1379,7 +1427,7 @@ static void batadv_tp_ack_unordered(struct batadv_tp_vars *tp_vars)
 		list_del(&un->list);
 		kfree(un);
 	}
-	spin_unlock_bh(&tp_vars->unacked_lock);
+	spin_unlock_bh(&tp_vars->common.unacked_lock);
 ...
 /**
@@ -1389,18 +1437,18 @@ static void batadv_tp_ack_unordered(struct batadv_tp_vars *tp_vars)
  *
...
@@ -1416,22 +1464,21 @@ batadv_tp_init_recv(struct batadv_priv *bat_priv,
 		goto out_unlock;
 	}
...
@@ -1452,7 +1499,7 @@ static void batadv_tp_recv_msg(struct batadv_priv *bat_priv,
 			       const struct sk_buff *skb)
 {
 	const struct batadv_icmp_tp_packet *icmp;
-	struct batadv_tp_vars *tp_vars;
...
@@ -1470,8 +1517,8 @@ static void batadv_tp_recv_msg(struct batadv_priv *bat_priv,
 			goto out;
 		}
 	} else {
-		tp_vars = batadv_tp_list_find_session(bat_priv, icmp->orig,
...
@@ -1515,7 +1562,7 @@ static void batadv_tp_recv_msg(struct batadv_priv *bat_priv,
...
+	batadv_tp_receiver_put(tp_vars);
 ...
 /**
@@ -1555,45 +1602,58 @@ void batadv_tp_meter_recv(struct batadv_priv *bat_priv, struct sk_buff *skb)
  */

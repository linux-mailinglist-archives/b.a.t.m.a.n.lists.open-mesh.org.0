...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 93391B21E19
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 12 Aug 2025 08:15:50 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 6156280700
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 12 Aug 2025 08:15:50 +0200 (CEST)
ARC-Seal: i=2; cv=pass; a=rsa-sha256; d=open-mesh.org; s=20121;
 t=1754979350;
 b=HTsosJvyvGKOnYJ5RxyXCFg5NFFGd5orv98zr60gPDrOqjTAi06+NlOpjR6/+/G6/wYzv
 gE0rsIeyR6ANY41vik39u7chvsIQcNtzLno/lXMV2hgRYLV4XXUOVkg2Om9vxH6zcUojEPA
 pgEUYJQcXfk5NuOiB6Rd6hgmTqvBf5s=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed;
 d=open-mesh.org; s=20121; t=1754979350; h=from : sender : reply-to :
 subject : date : message-id : to : cc : mime-version : content-type :
 content-transfer-encoding : content-id : content-description :
 resent-date : resent-from : resent-sender : resent-to : resent-cc :
 resent-message-id : in-reply-to : references : list-id : list-help :
 list-unsubscribe : list-subscribe : list-post : list-owner :
 list-archive; bh=oMSG0mRNDG1/2SwYtkvZDyde9l5Hz4ok38hgjt8Vi3I=;
 b=P++CX7W9tdqcbomBf2VSO3g1GftxeCjh9xL7rGFXPSTMlUUJD8TkJyULmgb067aa1Opec
 a3GMo0mmbeRK5JlavIQ7rS4gXBl5bCEBEjWXDtOmIW5S7dPfSPzI5KGQ6SDj+zeXk4kTWJn
 rqiKo9Yfoo5t1RKcdL3lCy7u7zWakN8=
...
Received: from mail-io1-f79.google.com (mail-io1-f79.google.com
 [209.85.166.79])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 7570880333
	for <b.a.t.m.a.n@lists.open-mesh.org>; Tue, 12 Aug 2025 03:07:30 +0200 (CEST)
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1754960860; a=rsa-sha256;
	cv=none;
	b=ETxEyqOXX+6cdV8+p24rY8YXdYykEtxzvkkg2fX/bgc8Uqr2x8fbeeeBoqIfnGSgToaemh
	Wxtl9sMHvbvLRQvmxSG+DJkP+3zrbV+4OjvuYwbhNKfZFPOfPXpWSvcMBLJcSV9oWxjUqN
	5vNShEL9kC1RASWLApXgGT9oi0FLS5U=
ARC-Authentication-Results: i=1;
 ...
 30JOaaAkbAK0flmXNYYReNccVQ.TbbTYRhfRePbagRag.PbZ@M3KW2WVRGUFZ5GODRSRYTGD7.apphosting.bounces.google.com
 designates 209.85.166.79 as permitted sender)
 smtp.mailfrom=30JOaaAkbAK0flmXNYYReNccVQ.TbbTYRhfRePbagRag.PbZ@M3KW2WVRGUFZ5GODRSRYTGD7.apphosting.bounces.google.com
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1754960860;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to; bh=oMSG0mRNDG1/2SwYtkvZDyde9l5Hz4ok38hgjt8Vi3I=;
	b=drbfYhZ/tLWhfqvLTJPSy4ha+opBS/HltYYLLSSGLzOL/ex38LSfFfwNoBSs/G9x20Fsge
	XJIFe9eZ8xsBcPKVeAB6/YNm68GWclhdS7PG07ap0Mnz/7kZ5vUGcEr9xklyTqGJ7tJZLL
	2qT5XjCya7Lr6r+464AxGvrxHluQyOI=
Received: by mail-io1-f79.google.com with SMTP id
 ca18e2360f4ac-881a05b0846so461670639f.1
        for <b.a.t.m.a.n@lists.open-mesh.org>;
 Mon, 11 Aug 2025 18:07:30 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        b=
X-Forwarded-Encrypted: i=1;
 AJvYcCW+HBoZa3VabdjJNfpnrMK/OwM6bs8ws6Fli6jCJ38FHCNEweqF9zuu08DKy8t5Mt3dik7f/OHZ84Yypw==@lists.open-mesh.org
X-Gm-Message-State: AOJu0YwQP/O+4ehHjQDox4PHdQYLY+9Tg0UjR07RTqchqczM8zr1muUH
	TCH5NTK/93uOKF0LSlEg1jhdYyrZjCfz1T94BS8zaioE6uYASAKsLRRlQU0yEfTIdyt4n37QVJG
	MZBnl/9MqtMLysxsT6gZGqzQ0dL6Lj+mqe4mTo2uKav0TuXoxxluVxtCO6ME=
X-Google-Smtp-Source: 
 AGHT+IHyjeCeDOBMBo3jW0FkCpJx7sRh0Zp/qhyXf95y4QnzvES9V9b5A9l02B8iiUKFHugPHdP4GV9xuq7YmPp1ogLUl1qvYVmv
MIME-Version: 1.0
...
Message-ID-Hash: URDAE6ISMG66PZQKOVWGTG7YF36R6WTV
X-Message-ID-Hash: URDAE6ISMG66PZQKOVWGTG7YF36R6WTV
X-Mailman-Approved-At: Tue, 12 Aug 2025 08:15:37 +0200
X-Mailman-Version: 3.3.8
Precedence: list
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking
 <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: 
 <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/URDAE6ISMG66PZQKOVWGTG7YF36R6WTV/>
List-Archive: 

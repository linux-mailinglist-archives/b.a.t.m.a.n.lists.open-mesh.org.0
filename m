...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id CC6B8229F2B
	for <lists+b.a.t.m.a.n@lfdr.de>; Wed, 22 Jul 2020 20:22:48 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 99C07804F6;
	Wed, 22 Jul 2020 20:22:47 +0200 (CEST)
Received: from mail-pf1-x444.google.com (mail-pf1-x444.google.com [IPv6:2607:f8b0:4864:20::444])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 27C3E8018B
	for <b.a.t.m.a.n@lists.open-mesh.org>; Wed, 22 Jul 2020 20:22:45 +0200 (CEST)
Received: by mail-pf1-x444.google.com with SMTP id z3so1702912pfn.12
        for <b.a.t.m.a.n@lists.open-mesh.org>; Wed, 22 Jul 2020 11:22:45 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=7oX+Ui6Om/fIjYvfDxV2/4AZHvhi7NBOu1a0cZDb96s=;
        b=
X-Gm-Message-State: AOAM532Q0Ih4warmlpIV1PAUm17K3yP1wmk7HPWp7LxmE9KUfMwJXzcw
	NxQXyT8nzeAe/RyfsMVAtWE=
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1595442165;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=7oX+Ui6Om/fIjYvfDxV2/4AZHvhi7NBOu1a0cZDb96s=;
	b=xnPWWmszLUrR0/GgIwaDcqsBsl4M7Gib0bVeclgFTWd4BSsFfyH3OEet4M1er1UYnRK0nc
	9WC7K/8muwrDT7uKqd3IIIHmbZwIrszcL2obM8CNMhnfEI4ltSb+yLjmi7lGpswP+WO0S5
	DkFXHVf4HA/1nhNascqASOLPpNeZof8=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1595442165; a=rsa-sha256;
	cv=none;
	b=tXhdifypZ5nXEzrHZudWNu3bNPTmaOzkqFt/cl+GPKHjXhGvYC0CM8DDovVaDF201d40W8
	W4oJBZ+fahAXngntlieMcup8vt11kQWZ8YnW2r89ug4jZX2CvktbrHNDp1I2c8TE2hzvzC
	sIV4tnq7dG1S+4MX//YoLkUra5F9d9E=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=gmail.com header.s=20161025 header.b=UR1CnosO;
	spf=pass (diktynna.open-mesh.org: domain of ericdumazet@gmail.com designates 2607:f8b0:4864:20::444 as permitted sender) smtp.mailfrom=ericdumazet@gmail.com
Message-ID-Hash: LZTACSMIMZ7PCUD5KS3J5Q3K23UKIH2P
X-Message-ID-Hash: LZTACSMIMZ7PCUD5KS3J5Q3K23UKIH2P
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/LZTACSMIMZ7PCUD5KS3J5Q3K23UKIH2P/>

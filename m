...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 9AB90656E62
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 27 Dec 2022 20:34:50 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 7EF48847F5;
	Tue, 27 Dec 2022 20:34:28 +0100 (CET)
Received: from mail.aperture-lab.de (mail.aperture-lab.de [IPv6:2a01:4f8:c2c:665b::1])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 31315847BB
	for <b.a.t.m.a.n@lists.open-mesh.org>; Tue, 27 Dec 2022 20:34:23 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1672169663;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=xOdF3Dl85ZqWUaVMfzxly1BHLKG8BdQdKvULwWIO95g=;
	b=FdsD3ZgjcVMckHeoBys09CP6lSK3cz4LY2CDkLK562EBo9KK9g1NOx7t2Gt2mJXZNdx7p1
	jqQhJZnHn4BSshhZ8HekejqnzDL9fltfuEzKJl1EeZQZSNn3QEMRAqC/skKbZtageSb5f9
	gS18WH1TX1EgEsvRNPa5Py/GG/rn+g0=
...
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1672169663; a=rsa-sha256;
	cv=none;
	b=wHOcNYPEIF0QRVsoUDr51hSgvuVD73mGX14nsIO8Vu/ovCZNytcXhpTdIMZnV/5Q9SnwXz
	wsnO9lPb4NmCFekHPZksqNx1nwavy5sg3o4C6+rRYpDaN5ug1KiMYq283n2SDsz7EIg2Eo
	pCjFJ0iietyuOn1rwRo1S4riYk7yayw=
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon) with ESMTPSA id 5A4293EC76;
	Tue, 27 Dec 2022 20:34:22 +0100 (CET)
From: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
To: b.a.t.m.a.n@lists.open-mesh.org
Cc: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
Subject: [PATCH v4 5/5] batman-adv: mcast: shrink tracker packet after scrubbing
Date: Tue, 27 Dec 2022 20:34:09 +0100
Message-Id: <20221227193409.13461-6-linus.luessing@c0d3.blue>
...
Message-ID-Hash: 2JKM2YFM4ZP6NZHDYKOXDNABRNQFHOLO
X-Message-ID-Hash: 2JKM2YFM4ZP6NZHDYKOXDNABRNQFHOLO
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/2JKM2YFM4ZP6NZHDYKOXDNABRNQFHOLO/>
...
@@ -531,6 +534,214 @@ batadv_mcast_forw_scrub_dests(struct batadv_priv *b=
at_priv,
 	}
 }
=20
...
+{
+	int ret =3D sizeof_field(struct batadv_tvlv_mcast_tracker, align);
+
...
@@ -615,6 +826,7 @@ static int batadv_mcast_forw_packet(struct batadv_pri=
v *bat_priv,
=20

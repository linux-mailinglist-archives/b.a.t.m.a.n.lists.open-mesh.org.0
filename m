...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 1FB5C6563FE
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 26 Dec 2022 17:03:15 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 945358461B;
	Mon, 26 Dec 2022 17:02:57 +0100 (CET)
Received: from mail.aperture-lab.de (mail.aperture-lab.de [IPv6:2a01:4f8:c2c:665b::1])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 150D6845C0
	for <b.a.t.m.a.n@lists.open-mesh.org>; Mon, 26 Dec 2022 17:02:54 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1672070574;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=4BcdoXD99jX/vFTfXDLxqcoKKB6W21RQ1QnF7zlYZ+c=;
	b=mj5O79z7ijVsvIikOkoyVSxFHrNjA4ZXzI2vtd0kPAlquiivbDUNk1rI6IekUyXn1d725+
	GGUba7sGcmb3V/xbF9ss7hsqEtpX0oOWDhQBw0ApyXg2HMDykTKuFDst60kF7RF0NY17Jg
	RZcNBlNB7g48BUVC8lt/BpeWYcBBuMM=
...
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1672070574; a=rsa-sha256;
	cv=none;
	b=sVY4nIFZ0Fel0BgLh4LOpWWanPd5ezZTbTDBwOmedHHc0IrzDGpvI96uxU20LO2lVE7NHP
	zhv+wD14wExbu8+PVCx42gTxmdX/5TEU3x5R5jP/r9+zjAAd8qEyvwDqbAy8mXsbd2+oqN
	Z6JBltzW3MbczEuhvdl277HJkFz8Pzk=
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon) with ESMTPSA id 785263EC75;
	Mon, 26 Dec 2022 17:02:53 +0100 (CET)
From: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
To: b.a.t.m.a.n@lists.open-mesh.org
Cc: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
Subject: [PATCH 3/5] batman-adv: mcast: implement multicast packet reception and forwarding
Date: Mon, 26 Dec 2022 17:02:31 +0100
Message-Id: <20221226160233.9521-4-linus.luessing@c0d3.blue>
...
Message-ID-Hash: BX5EDE2TPU2O3QOSBRHZB2U6MAT6YYA3
X-Message-ID-Hash: BX5EDE2TPU2O3QOSBRHZB2U6MAT6YYA3
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/BX5EDE2TPU2O3QOSBRHZB2U6MAT6YYA3/>

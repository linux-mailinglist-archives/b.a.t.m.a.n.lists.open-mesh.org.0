...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id EE738656501
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 26 Dec 2022 21:43:02 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 79E5C84786;
	Mon, 26 Dec 2022 21:42:54 +0100 (CET)
Received: from mail.aperture-lab.de (mail.aperture-lab.de [IPv6:2a01:4f8:c2c:665b::1])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 136A1846E9
	for <b.a.t.m.a.n@lists.open-mesh.org>; Mon, 26 Dec 2022 21:42:49 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1672087369;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=P1ej9wkqLvJRC/2bCJ8nWI3g1SqL5q2U2rBmunepPFY=;
	b=Yx+IMD3a2sLFqGy7RyfwrVfKSTHvTrl8YVirdjg7Y7p3Xz9w6Brc6QylAREKq974Xb+e8x
	i3sTq3XLwIru4hLl4tyGR9lqxcyooV7Vp935TeWtS1k4bQGPlMscb8C43qO3OOYNZr5DkH
	d5zxSloFAKDUp8YTp5kBeG5rVHJYvj4=
...
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1672087369; a=rsa-sha256;
	cv=none;
	b=sumX8vA1oL3wLuT4B+9mPrK5ao9TgDQ0ufTtYgxfk9dSfZfkU2K2xRe2yvy6yN7qtGdU1/
	e6vKMfyqik8084/Px+utA+r5WhIr1QDbr4MvfOHXHfwQ3gQnjqSYWxB5R8wrGHWqOB6K6K
	cTpM3TPfyKCqPg/iCRDkTVbgWNda3Yo=
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon) with ESMTPSA id 8734841C91;
	Mon, 26 Dec 2022 21:42:48 +0100 (CET)
From: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
To: b.a.t.m.a.n@lists.open-mesh.org
Cc: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
Subject: [PATCH v3 3/5] batman-adv: mcast: implement multicast packet reception and forwarding
Date: Mon, 26 Dec 2022 21:42:35 +0100
Message-Id: <20221226204237.10403-4-linus.luessing@c0d3.blue>
...
Message-ID-Hash: QFKMYJRDYAFQ74R266BRTYX2L2OPLHGY
X-Message-ID-Hash: QFKMYJRDYAFQ74R266BRTYX2L2OPLHGY
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/QFKMYJRDYAFQ74R266BRTYX2L2OPLHGY/>
...
@@ -243,6 +243,37 @@ static u8 batadv_mcast_mla_rtr_flags_get(struct bata=
dv_priv *bat_priv,
 	return flags;
 }
=20
...
+
  ...
  * @bat_priv: the bat priv with all the soft interface information
@@ -264,6 +295,7 @@ batadv_mcast_mla_flags_get(struct batadv_priv *bat_pr=
iv)
...
=20
 	if (!bridge)
 		return mla_flags;
@@ -814,23 +846,25 @@ static void batadv_mcast_flags_log(struct batadv_pr=
...
=20
 /**
@@ -1828,6 +1862,10 @@ void batadv_mcast_init(struct batadv_priv *bat_pri=
v)

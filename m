...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id D9697273A7F
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 22 Sep 2020 08:03:19 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 97560807EF;
	Tue, 22 Sep 2020 08:03:18 +0200 (CEST)
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 8C5F780092
	for <b.a.t.m.a.n@lists.open-mesh.org>; Mon, 21 Sep 2020 22:49:24 +0200 (CEST)
IronPort-SDR: GjR201rAH6beOhqSJK+PGUTL737d09BlUTp5C5HCXxcXI3ASTxTRNynnfLhxtwaZ3l+DkNZ6P+
 ywZl0ubs4HKA==
X-IronPort-AV: E=McAfee;i="6000,8403,9751"; a="159766196"
X-IronPort-AV: E=Sophos;i="5.77,288,1596524400";
   d="gz'50?scan'50,208,50";a="159766196"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Sep 2020 13:49:19 -0700
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1600721366;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=AO7XRN7gYwwac5kGjzZMxKiyr2B/jdGeOsRe/B+Csno=;
	b=cMStf2zspNUtrZ1/aAdpeuGsK1Bvl/G5UdJKQv0Xz4guU2LbloMzoyc2a+Rtp96X5YRC+G
	BDmon8D6zydAbkZU4AVbfnjVyZpwRmB3zUAqWOD562tsEJMtM8IDpa3TCC0IxQCGseADnh
	jPhW0+QByoIDKoothOHYgLdPALoG0N0=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1600721366; a=rsa-sha256;
	cv=none;
	b=k5IwfFam0WC/KBrSrN0Wd8E3cuUR0UHLbr83UJ6c/qtVvwfx+Gzik3yV2/U49Y6uRgvYad
	UKBbgp6EDCklcyC/lFAy7Dh5BpAMAfD1xkoAmB2ne6YiKTZpXf5Y8RJiPvDYU8Id3aIOP5
	OLXkwVlY1HK++nEqOQQSsNGKheNYAXE=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=none;
	spf=pass (diktynna.open-mesh.org: domain of lkp@intel.com designates 192.55.52.115 as permitted sender) smtp.mailfrom=lkp@intel.com
Content-Transfer-Encoding: 7bit
X-MailFrom: lkp@intel.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-b.a.t.m.a.n.lists.open-mesh.org-0; header-match-b.a.t.m.a.n.lists.open-mesh.org-1
Message-ID-Hash: LEAZB5XHDOG2A6NT4BCSZHVR7UNFFV3L
X-Message-ID-Hash: LEAZB5XHDOG2A6NT4BCSZHVR7UNFFV3L
X-Mailman-Approved-At: Tue, 22 Sep 2020 06:03:16 +0200
CC: kbuild-all@lists.01.org, clang-built-linux@googlegroups.com, roopa@nvidia.com, davem@davemloft.net, bridge@lists.linux-foundation.org, Nikolay Aleksandrov <nikolay@nvidia.com>, Marek Lindner <mareklindner@neomailbox.ch>, b.a.t.m.a.n@lists.open-mesh.org
X-Mailman-Version: 3.2.1
Precedence: list
Reply-To: The list for a Better Approach To Mobile Ad-hoc Networking <b.a.t.m.a.n@lists.open-mesh.org>
List-Id: The list for a Better Approach To Mobile Ad-hoc Networking <b.a.t.m.a.n.lists.open-mesh.org>
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/LEAZB5XHDOG2A6NT4BCSZHVR7UNFFV3L/>
...
url:    https://github.com/0day-ci/linux/commits/Nikolay-Aleksandrov/net-=
bridge-mcast-IGMPv3-MLDv2-fast-path-part-2/20200921-185933
base:   https://git.kernel.org/pub/scm/linux/kernel/git/davem/net-next.gi=
t 3cec0369905d086a56a7515f3449982403057599
config: arm-randconfig-r036-20200920 (attached as .config)
compiler: clang version 12.0.0 (https://github.com/llvm/llvm-project 4e8c=
028158b56d9c2142a62464e8e0686bde3584)
...
>> net/batman-adv/multicast.c:564:22: error: no member named 'u' in 'stru=
ct br_ip'
                   ip_eth_mc_map(src->u.ip4, dst);
                                 ~~~  ^
   net/batman-adv/multicast.c:567:25: error: no member named 'u' in 'stru=
ct br_ip'
                   ipv6_eth_mc_map(&src->u.ip6, dst);
                                    ~~~  ^
   2 errors generated.

# https://github.com/0day-ci/linux/commit/195fb98d13499e5a7c5a2a750e6a7e0=
cbcfaccdc
git remote add linux-review https://github.com/0day-ci/linux
git fetch --no-tags linux-review Nikolay-Aleksandrov/net-bridge-mcast-IGM=
Pv3-MLDv2-fast-path-part-2/20200921-185933
git checkout 195fb98d13499e5a7c5a2a750e6a7e0cbcfaccdc
vim +564 net/batman-adv/multicast.c

c5caf4ef34e277 Linus L=FCssing  2014-02-15  548 =20
687937ab34896d Linus L=FCssing  2016-05-10  549  /**
7e9a8c2ce7c5f8 Sven Eckelmann 2017-12-02  550   * batadv_mcast_mla_br_add=
r_cpy() - copy a bridge multicast address
687937ab34896d Linus L=FCssing  2016-05-10  551   * @dst: destination to =
write to - a multicast MAC address
687937ab34896d Linus L=FCssing  2016-05-10  552   * @src: source to read =
from - a multicast IP address
687937ab34896d Linus L=FCssing  2016-05-10  553   *
687937ab34896d Linus L=FCssing  2016-05-10  554   * Converts a given mult=
icast IPv4/IPv6 address from a bridge
687937ab34896d Linus L=FCssing  2016-05-10  555   * to its matching multi=
cast MAC address and copies it into the given
687937ab34896d Linus L=FCssing  2016-05-10  556   * destination buffer.
687937ab34896d Linus L=FCssing  2016-05-10  557   *
687937ab34896d Linus L=FCssing  2016-05-10  558   * Caller needs to make =
sure the destination buffer can hold
687937ab34896d Linus L=FCssing  2016-05-10  559   * at least ETH_ALEN byt=
es.
687937ab34896d Linus L=FCssing  2016-05-10  560   */
687937ab34896d Linus L=FCssing  2016-05-10  561  static void batadv_mcast=
_mla_br_addr_cpy(char *dst, const struct br_ip *src)
687937ab34896d Linus L=FCssing  2016-05-10  562  {
687937ab34896d Linus L=FCssing  2016-05-10  563  	if (src->proto =3D=3D h=
tons(ETH_P_IP))
687937ab34896d Linus L=FCssing  2016-05-10 @564  		ip_eth_mc_map(src->u.i=
p4, dst);
687937ab34896d Linus L=FCssing  2016-05-10  565  #if IS_ENABLED(CONFIG_IP=
V6)
687937ab34896d Linus L=FCssing  2016-05-10  566  	else if (src->proto =3D=
=3D htons(ETH_P_IPV6))
687937ab34896d Linus L=FCssing  2016-05-10  567  		ipv6_eth_mc_map(&src->=
u.ip6, dst);
687937ab34896d Linus L=FCssing  2016-05-10  568  #endif
687937ab34896d Linus L=FCssing  2016-05-10  569  	else
687937ab34896d Linus L=FCssing  2016-05-10  570  		eth_zero_addr(dst);
687937ab34896d Linus L=FCssing  2016-05-10  571  }
687937ab34896d Linus L=FCssing  2016-05-10  572 =20

...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5321537A56E
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 11 May 2021 13:08:36 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 16D7983F09;
...
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on20626.outbound.protection.outlook.com [IPv6:2a01:111:f400:fe5a::626])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 763B080CDD
	for <b.a.t.m.a.n@lists.open-mesh.org>; Tue, 11 May 2021 11:12:46 +0200 (CEST)
...
X-MS-Exchange-AntiSpam-MessageData: 
	=?utf-8?B?eEJueHNqWVhaZ3lJZEp5N3o4UER0OXR6R0VxL1ZOMFB6YkU2SUg0Snl3S3JM?=
...
ARC-Seal: i=2; s=20121; d=open-mesh.org; t=1620724366; a=rsa-sha256;
	cv=pass;
	b=eTxb521tdPl+vHhrpmpU3oGEVIinFlIQNsRTvampRwlpAI5qBYVWyYNFffgT/rT9gqoCVY
	FQAgBsMoPAPB0muibMBk0CKODs45GP7oK5mhsdMIUgN8u5cQeDjWpvkzZwM5PwrKjYACor
	LoIWVHDnoxQGAtJ2+rHzmP/A5fEEmP0=
ARC-Authentication-Results: i=2;
	diktynna.open-mesh.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=TaN2A0vg;
	arc=pass ("microsoft.com:s=arcselector9901:i=1");
	spf=softfail (diktynna.open-mesh.org: 2a01:111:f400:fe5a::626 is neither permitted nor denied by domain of nikolay@nvidia.com) smtp.mailfrom=nikolay@nvidia.com
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1620724366;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=tnHV5mJNnwgq/koCsth+OHwF0qvxxSoE41hzLBBf3f4=;
	b=Qz9QAQ4y3cyTjBI68Df1NY+imIsN5wh20ObZibY1yA+TQo8L/lnX94p8+b6QuXPLoOc87T
	pHDfdlHIwIQT7XjDkVNGmSbVyyFvSOjAppvvwMUqCdJ/K8IDLSHzBX1n74Vb0gSvOdVJHS
	nOgIBphc0c96MMgFPxA+apwQLiZZhfc=
Content-Transfer-Encoding: quoted-printable
X-MailFrom: nikolay@nvidia.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-b.a.t.m.a.n.lists.open-mesh.org-0; header-match-b.a.t.m.a.n.lists.open-mesh.org-1
Message-ID-Hash: F2QWDEIRTPWWIEQHZEF4N25CCOUERQHW
X-Message-ID-Hash: F2QWDEIRTPWWIEQHZEF4N25CCOUERQHW
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/F2QWDEIRTPWWIEQHZEF4N25CCOUERQHW/>
...
> @@ -264,6 +264,16 @@ static void maybe_deliver_addr(struct net_bridge_p=
ort *p, struct sk_buff *skb,
...
Inline functions in .c files are not allowed, please move these to br_pri=
vate.h

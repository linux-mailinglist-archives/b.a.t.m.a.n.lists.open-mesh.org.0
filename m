...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id BC2AC656408
	for <lists+b.a.t.m.a.n@lfdr.de>; Mon, 26 Dec 2022 17:16:31 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 75E53846ED;
	Mon, 26 Dec 2022 17:16:13 +0100 (CET)
Received: from mail.aperture-lab.de (mail.aperture-lab.de [IPv6:2a01:4f8:c2c:665b::1])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 1276984639
	for <b.a.t.m.a.n@lists.open-mesh.org>; Mon, 26 Dec 2022 17:16:10 +0100 (CET)
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1672071370;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=aPGOhesQom/YLhoY6ESOg10tRwJoPG2UUrZckhKUQsQ=;
	b=EvCG74pzsTnrxK186OlWbNXPA4ym37EJparkFCo8l2I/edzSLN5eLbMHdBU1lsdCkWJ0gD
	IM5XISKjm0noq2v1YH5jWoSYLtroPQYT9Hs87tzHmQDF7wvPgRMmQuBfgdV5jfgmghIYKL
	0abkSPhTAOhGmU743HRWVY71pQlDtgU=
...
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1672071370; a=rsa-sha256;
	cv=none;
	b=c7iD6QJhR+TRPEIBSitjdXvUCNm1bz/cnQYODHn/J3PptudZKfStu7BzyFvDQf5wT040Xg
	9DvPfyOfg958FslmIKu3eRuczM4aDc+lzPgnaJrHUN+csuV43mvOxvl72qHRYl4j/Db5u9
	PvO0k4PUIX2PyIhBd2qbPm/4ceXYHLM=
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon) with ESMTPSA id 6824141C91;
	Mon, 26 Dec 2022 17:16:09 +0100 (CET)
From: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
To: b.a.t.m.a.n@lists.open-mesh.org
Cc: =?UTF-8?q?Linus=20L=C3=BCssing?= <linus.luessing@c0d3.blue>
Subject: [PATCH v2 5/5] batman-adv: mcast: shrink tracker packet after scrubbing
Date: Mon, 26 Dec 2022 17:15:54 +0100
Message-Id: <20221226161554.9657-6-linus.luessing@c0d3.blue>
...
Message-ID-Hash: DYJNME3JMC6RK6MFDSSM34SRMQDKWOUG
X-Message-ID-Hash: DYJNME3JMC6RK6MFDSSM34SRMQDKWOUG
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/DYJNME3JMC6RK6MFDSSM34SRMQDKWOUG/>

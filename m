...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A00B37A572
	for <lists+b.a.t.m.a.n@lfdr.de>; Tue, 11 May 2021 13:08:52 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 2CC6783F83;
	Tue, 11 May 2021 13:08:47 +0200 (CEST)
Received: from NAM11-DM6-obe.outbound.protection.outlook.com (mail-dm6nam11on20614.outbound.protection.outlook.com [IPv6:2a01:111:f400:7eaa::614])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 7845983EBD
	for <b.a.t.m.a.n@lists.open-mesh.org>; Tue, 11 May 2021 11:13:53 +0200 (CEST)
...
X-MS-Exchange-AntiSpam-MessageData: 
	=?utf-8?B?MC9rdHdQWElQMlhZaitCbGxOakl3czluZjFEN1FnRUJXVmcwS3dNc0FYREpT?=
...
ARC-Seal: i=2; s=20121; d=open-mesh.org; t=1620724433; a=rsa-sha256;
	cv=pass;
	b=MlnPpxc/qNu0DsfFEnRn8ldnbieP5VzoPoiKhUGFukBf21PBlBEOp2Igar+M0FgSSznQsa
	VZ72J+z6MNIkJCE75Wf2aa4e4vV5soNRTgyNdA15uNYILg4pJuKcAqcq2/UkxUYV7DRBUq
	BpRocQIKdwA63L2EwMwobsCVIHUK6ME=
ARC-Authentication-Results: i=2;
	diktynna.open-mesh.org;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=QWJlRWqn;
	arc=pass ("microsoft.com:s=arcselector9901:i=1");
	spf=softfail (diktynna.open-mesh.org: 2a01:111:f400:7eaa::614 is neither permitted nor denied by domain of nikolay@nvidia.com) smtp.mailfrom=nikolay@nvidia.com
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	s=20121; t=1620724433;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:dkim-signature;
	bh=E0k2TY0Csq3Ttf2PgdwRjxpN1/zgPzBYnPla7sPL/sY=;
	b=GyNCRqu6L1FbtgOrnlKtHMwz+O7pWNzKdVMym8izOjEhl4Tch1ZFlzPU2NCdV4XLpGUIS/
	Yp/+4PZ1WXRzARIxz3sVLErZKddTjpewXRJCcKs/uwH67z2uJfKWqM/fmcAW835VDm7VZ8
	van/Bh+z6uILOIph5CfxSjHFJUbRWwY=
Content-Transfer-Encoding: quoted-printable
X-MailFrom: nikolay@nvidia.com
X-Mailman-Rule-Hits: nonmember-moderation
X-Mailman-Rule-Misses: dmarc-mitigation; no-senders; approved; emergency; loop; banned-address; member-moderation; header-match-b.a.t.m.a.n.lists.open-mesh.org-0; header-match-b.a.t.m.a.n.lists.open-mesh.org-1
Message-ID-Hash: WLNPBBW25FKYV26FP4ZXQBK25VOTOWWH
X-Message-ID-Hash: WLNPBBW25FKYV26FP4ZXQBK25VOTOWWH
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/WLNPBBW25FKYV26FP4ZXQBK25VOTOWWH/>
...
> @@ -2708,19 +2692,36 @@ static void br_multicast_mark_router(struct net=
_bridge *br,
...
>  				   struct net_bridge_port *port,
>  				   struct sk_buff *skb,
> @@ -2768,8 +2769,8 @@ static void br_ip4_multicast_query(struct net_bri=
dge *br,
...
>  	}
> =20
> @@ -2856,8 +2857,8 @@ static int br_ip6_multicast_query(struct net_brid=
ge *br,

...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [IPv6:2a01:4f8:241:fc1:136:243:236:17])
	by mail.lfdr.de (Postfix) with ESMTPS id 9565D2CF144
	for <lists+b.a.t.m.a.n@lfdr.de>; Fri,  4 Dec 2020 16:55:16 +0100 (CET)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id BF672809F8;
	Fri,  4 Dec 2020 16:55:10 +0100 (CET)
Received: from simonwunderlich.de (simonwunderlich.de [79.140.42.25])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 8060C807A0
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	...
	bh=L3aYqR9BRsKy6A5BS4LaUugJe1TcJD5jEMSq24gAgow=;
	b=yausJly1RVqxTLXjuVQVkQdTUTE3abwzwGqnCYlQUXrF/JILGvmc/6Ocw6l2IKFZTtXqjT
	GKQlE6vPJQzyusJR8XLJptF/bAdAU5wbV1mGGyQZcDCi2Etv1XcKtfUhaLonfJiiQCSeGJ
	qrdQB3/u2LywHwCcTXg+Q66SmDyjL6w=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1607097307; a=rsa-sha256;
	cv=none;
	b=hrMYHThJbsCgLlX1AQAboHnpQNU+TladQ1DMBUHER269MwZOJbflEhSb9mwqBb7G0QgKaK
	EDsXO+klwa4Uxv70wOwJYn9MEEDY1jmRlSb7e3+iFhpu0qDFaGf42cUCazx9wVfxXWOJNC
	4ZCp9Z82v1p1qsf1zttPkCWx5v7ouHI=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=none;
	spf=pass (diktynna.open-mesh.org: domain of sw@simonwunderlich.de designates 79.140.42.25 as permitted sender) smtp.mailfrom=sw@simonwunderlich.de
Content-Transfer-Encoding: quoted-printable
Message-ID-Hash: IXZO77FUBVN3PXKZK64G7U2HGWWAKLRP
X-Message-ID-Hash: IXZO77FUBVN3PXKZK64G7U2HGWWAKLRP
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/IXZO77FUBVN3PXKZK64G7U2HGWWAKLRP/>
...
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -3120,8 +3120,6 @@ Q:	https://patchwork.open-mesh.org/project/batman/l=
ist/
...
=20
 /**
@@ -889,13 +888,9 @@ void batadv_hardif_disable_interface(struct batadv_h=
...
=20
 	ASSERT_RTNL();
=20
@@ -921,10 +915,6 @@ batadv_hardif_add_interface(struct net_device *net_d=
ev)
 	if (!hard_iface)
 		goto release_dev;
=20
...
@@ -954,8 +944,6 @@ batadv_hardif_add_interface(struct net_device *net_de=
v)
=20
 	return hard_iface;
=20
...
-	kfree(hard_iface);
 release_dev:
 	dev_put(net_dev);
 out:
@@ -976,7 +964,6 @@ static void batadv_hardif_remove_interface(struct bat=
...
=20
@@ -994,7 +981,6 @@ static int batadv_hard_if_event_softif(unsigned long =
event,
=20
 	switch (event) {
...
=20
 /**
@@ -575,7 +573,6 @@ struct batadv_softif_vlan *batadv_softif_vlan_get(str=
...
=20
@@ -602,19 +599,6 @@ int batadv_softif_create_vlan(struct batadv_priv *ba=
...
-
 	 ...
 	 * flag
 	 */
@@ -642,7 +626,6 @@ static void batadv_softif_destroy_vlan(struct batadv_=
priv *bat_priv,
...
=20
@@ -662,7 +645,6 @@ static int batadv_interface_add_vid(struct net_device=
 *dev, __be16 proto,
 {
...
@@ -682,17 +664,6 @@ static int batadv_interface_add_vid(struct net_devic=
e *dev, __be16 proto,
 	if (!vlan)
...
@@ -1161,28 +1132,6 @@ struct net_device *batadv_softif_create(struct net=
 *net, const char *name)
 	return soft_iface;
 }
=20
...
ia
  *  netlink
@@ -1209,7 +1158,6 @@ static void batadv_softif_destroy_netlink(struct ne=
t_device *soft_iface,
 		batadv_softif_vlan_put(vlan);
 	}
=20

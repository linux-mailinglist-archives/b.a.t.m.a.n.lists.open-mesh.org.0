...
Received: from diktynna.open-mesh.org (diktynna.open-mesh.org [136.243.236.17])
	by mail.lfdr.de (Postfix) with ESMTPS id 83FE73E3C2C
	for <lists+b.a.t.m.a.n@lfdr.de>; Sun,  8 Aug 2021 20:28:36 +0200 (CEST)
Received: from diktynna.open-mesh.org (localhost [IPv6:::1])
	by diktynna.open-mesh.org (Postfix) with ESMTP id 2DDF8824AD;
	Sun,  8 Aug 2021 20:28:35 +0200 (CEST)
Received: from dvalin.narfation.org (dvalin.narfation.org [213.160.73.56])
	by diktynna.open-mesh.org (Postfix) with ESMTPS id 41DE7803A9
	for <b.a.t.m.a.n@lists.open-mesh.org>; Sun,  8 Aug 2021 20:28:31 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=narfation.org;
	s=20121; t=1628446996;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=cTlLb6H2OWqwI1tv47RhHVuDhIm3H16xX33hmxnc5ss=;
	b=wAvqn4/iFqazLFbGhisYfAeqj/TeFByE1kfS/dxOaJF93j+6B3EonUycRN+UcF+koz4vQG
	0a99jNRJV3VK1n68zolAGMt/EdqCToK5Zd1AwWtedjJwd2+Gs2UGZVo8xrO6AFJAV82oCP
	DIrbjb/U8Px4wHrwdiGEB9dgH4qUoso=
From: Sven Eckelmann <sven@narfation.org>
To: b.a.t.m.a.n@lists.open-mesh.org
Cc: Sven Eckelmann <sven@narfation.org>
Subject: [PATCH v2 2/2] batman-adv: Drop NULL check before dropping references
Date: Sun,  8 Aug 2021 20:23:05 +0200
Message-Id: <20210808182306.18629-2-sven@narfation.org>
X-Mailer: git-send-email 2.30.2
In-Reply-To: <20210808182306.18629-1-sven@narfation.org>
References: <20210808182306.18629-1-sven@narfation.org>
MIME-Version: 1.0
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=open-mesh.org;
	...
	bh=cTlLb6H2OWqwI1tv47RhHVuDhIm3H16xX33hmxnc5ss=;
	b=K2dsyGBWyQD9ch8UBw0pvhAvj4kFfLP3+OvrFqpWF8fye7sSHhQ9nAv598VNxouRnzCiuL
	t0zqmZd6ljQ2a+rnZuKM6oALOSfDc0Qo3xx5xVKEPj/Gcq5VH370fIv7GBoyNmnqe5Aux8
	NIGXPzQtfuUFA0osUSXBSsw0ue4rVeU=
ARC-Seal: i=1; s=20121; d=open-mesh.org; t=1628447311; a=rsa-sha256;
	cv=none;
	b=N74E7CvLf3a6lmIyDKCPbvdClvklJbP5AfeZuNnTMFdV8qt66rR+7d/wGEy2xMTOFs9VHg
	01EU9c7vLRp8EjdzTKRiKGkVlVbMfNCk+tdIzjmPpjoC71rA8n5LbXAF+GNppe8jDc2USF
	fRtCuZtVoE8eHR2dX9HrmVTBBGOSALE=
ARC-Authentication-Results: i=1;
	diktynna.open-mesh.org;
	dkim=pass header.d=narfation.org header.s=20121 header.b="wAvqn4/i";
	spf=pass (diktynna.open-mesh.org: domain of sven@narfation.org designates 213.160.73.56 as permitted sender) smtp.mailfrom=sven@narfation.org
Content-Transfer-Encoding: quoted-printable
Message-ID-Hash: YEULL7XDIODBZX2HLSY7RZLRUFDSFTPD
X-Message-ID-Hash: YEULL7XDIODBZX2HLSY7RZLRUFDSFTPD
...
Archived-At: <https://lists.open-mesh.org/mailman3/hyperkitty/list/b.a.t.m.a.n@lists.open-mesh.org/message/YEULL7XDIODBZX2HLSY7RZLRUFDSFTPD/>
...
index 12022378..f94f538f 100644
...
index b98aea95..54e41fc7 100644
...
index 423c2d17..71999e13 100644
...
index a0a9636d..1d750f3c 100644
...
ge_loop_avoidance.c
index 134db98a..16697443 100644
...
ributed-arp-table.c
index 60f1ae1a..2f008e32 100644
...
n.c
index a5d9d800..0899a729 100644
...
ent.c
index c36a8132..b7466136 100644
...
ace.c
index 55d97e18..8a2b78f9 100644
...
index 0158f267..a3b6658e 100644
...
index b6cc746e..29276284 100644
...
ing.c
index 136b1a8e..9f06132e 100644
...
index 3693f47d..aadc653c 100644
...
index bb9e93e3..970d0d7c 100644
...
index 0b9dd29d..2a33458b 100644
...
ace.c
index e3580ddb..0604b027 100644
...
index b0e67cd5..56b9fe97 100644
...
ion-table.c
index b89a4ed5..e0b3dace 100644
...
index 1efea0ac..99277337 100644
